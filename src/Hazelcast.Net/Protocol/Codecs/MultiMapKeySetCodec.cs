...
namespace Hazelcast.Protocol.Codecs
{
    ...
    ///</summary>
#if SERVER_CODEC
    internal static class MultiMapKeySetServerCodec
#else
    internal static class MultiMapKeySetCodec
#endif
    {
        public const int RequestMessageType = 132096; // 0x020400
        public const int ResponseMessageType = 132097; // 0x020401
