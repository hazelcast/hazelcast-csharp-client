...
namespace Hazelcast.Protocol.Codecs
{
    ...
    ///</summary>
#if SERVER_CODEC
    internal static class TransactionalListRemoveServerCodec
#else
    internal static class TransactionalListRemoveCodec
#endif
    {
        public const int RequestMessageType = 1114624; // 0x110200
        public const int ResponseMessageType = 1114625; // 0x110201
        ...
        public static ClientMessage EncodeRequest(string name, Guid txnId, long threadId, IData item)
        {
            ...
            {
                IsRetryable = false,
                OperationName = "TransactionalList.Remove"
            };
