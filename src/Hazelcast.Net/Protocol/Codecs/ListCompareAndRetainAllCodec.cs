...
namespace Hazelcast.Protocol.Codecs
{
    ...
    ///</summary>
#if SERVER_CODEC
    internal static class ListCompareAndRetainAllServerCodec
#else
    internal static class ListCompareAndRetainAllCodec
#endif
    {
        public const int RequestMessageType = 329728; // 0x050800
        public const int ResponseMessageType = 329729; // 0x050801
        ...
        public static ClientMessage EncodeRequest(string name, ICollection<IData> values)
        {
            ...
            {
                IsRetryable = false,
                OperationName = "List.CompareAndRetainAll"
            };
