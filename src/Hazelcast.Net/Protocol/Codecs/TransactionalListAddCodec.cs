...
namespace Hazelcast.Protocol.Codecs
{
    ...
    ///</summary>
#if SERVER_CODEC
    internal static class TransactionalListAddServerCodec
#else
    internal static class TransactionalListAddCodec
#endif
    {
        public const int RequestMessageType = 1114368; // 0x110100
        public const int ResponseMessageType = 1114369; // 0x110101
        ...
        public static ClientMessage EncodeRequest(string name, Guid txnId, long threadId, IData item)
        {
            ...
            {
                IsRetryable = false,
                OperationName = "TransactionalList.Add"
            };
