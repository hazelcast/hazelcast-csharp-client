...
namespace Hazelcast.Protocol.Codecs
{
    ...
    ///</summary>
#if SERVER_CODEC
    internal static class CPSessionGenerateThreadIdServerCodec
#else
    internal static class CPSessionGenerateThreadIdCodec
#endif
    {
        public const int RequestMessageType = 2032640; // 0x1F0400
        public const int ResponseMessageType = 2032641; // 0x1F0401
        ...
        public static ClientMessage EncodeRequest(Hazelcast.CP.CPGroupId groupId)
        {
            var clientMessage = new ClientMessage
            {
                IsRetryable = true,
                OperationName = "CPSession.GenerateThreadId"
            };
