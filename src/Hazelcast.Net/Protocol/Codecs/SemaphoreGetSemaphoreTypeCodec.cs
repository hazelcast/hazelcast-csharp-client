...
namespace Hazelcast.Protocol.Codecs
{
    ...
    ///</summary>
#if SERVER_CODEC
    internal static class SemaphoreGetSemaphoreTypeServerCodec
#else
    internal static class SemaphoreGetSemaphoreTypeCodec
#endif
    {
        public const int RequestMessageType = 788224; // 0x0C0700
        public const int ResponseMessageType = 788225; // 0x0C0701
        ...
        public static ClientMessage EncodeRequest(string proxyName)
        {
            ...
            {
                IsRetryable = true,
                OperationName = "Semaphore.GetSemaphoreType"
            };
