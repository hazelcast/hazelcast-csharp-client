...
namespace Hazelcast.Protocol.Codecs
{
    ...
    ///</summary>
#if SERVER_CODEC
    internal static class TransactionalMapValuesServerCodec
#else
    internal static class TransactionalMapValuesCodec
#endif
    {
        public const int RequestMessageType = 921600; // 0x0E1000
        public const int ResponseMessageType = 921601; // 0x0E1001
        ...
        public static ClientMessage EncodeRequest(string name, Guid txnId, long threadId)
        {
            ...
            {
                IsRetryable = false,
                OperationName = "TransactionalMap.Values"
            };
