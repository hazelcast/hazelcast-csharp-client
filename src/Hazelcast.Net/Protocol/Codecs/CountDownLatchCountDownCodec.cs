...
namespace Hazelcast.Protocol.Codecs
{
    ...
    ///</summary>
#if SERVER_CODEC
    internal static class CountDownLatchCountDownServerCodec
#else
    internal static class CountDownLatchCountDownCodec
#endif
    {
        public const int RequestMessageType = 721664; // 0x0B0300
        public const int ResponseMessageType = 721665; // 0x0B0301
        private const int RequestInvocationUidFieldOffset = Messaging.FrameFields.Offset.PartitionId + BytesExtensions.SizeOfInt;
        private const int RequestExpectedRoundFieldOffset = RequestInvocationUidFieldOffset + BytesExtensions.SizeOfCodecGuid;
        private const int RequestInitialFrameSize = RequestExpectedRoundFieldOffset + BytesExtensions.SizeOfInt;
        ...
        public static ClientMessage EncodeRequest(Hazelcast.CP.CPGroupId groupId, string name, Guid invocationUid, int expectedRound)
        {
            var clientMessage = new ClientMessage
            {
                IsRetryable = true,
                OperationName = "CountDownLatch.CountDown"
            };
            ...
            initialFrame.Bytes.WriteIntL(RequestExpectedRoundFieldOffset, expectedRound);
        ...
        public static RequestParameters DecodeRequest(ClientMessage clientMessage)
        {
            ...
            request.ExpectedRound = initialFrame.Bytes.ReadIntL(RequestExpectedRoundFieldOffset);
