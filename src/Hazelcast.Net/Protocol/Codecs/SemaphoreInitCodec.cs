...
namespace Hazelcast.Protocol.Codecs
{
    ...
    ///</summary>
#if SERVER_CODEC
    internal static class SemaphoreInitServerCodec
#else
    internal static class SemaphoreInitCodec
#endif
    {
        public const int RequestMessageType = 786688; // 0x0C0100
        public const int ResponseMessageType = 786689; // 0x0C0101
        private const int RequestPermitsFieldOffset = Messaging.FrameFields.Offset.PartitionId + BytesExtensions.SizeOfInt;
        ...
        public static ClientMessage EncodeRequest(Hazelcast.CP.CPGroupId groupId, string name, int permits)
        {
            var clientMessage = new ClientMessage
            {
                IsRetryable = true,
                OperationName = "Semaphore.Init"
            };
