...
namespace Hazelcast.Protocol.Codecs
{
    ...
    ///</summary>
#if SERVER_CODEC
    internal static class SemaphoreChangeServerCodec
#else
    internal static class SemaphoreChangeCodec
#endif
    {
        public const int RequestMessageType = 787712; // 0x0C0500
        public const int ResponseMessageType = 787713; // 0x0C0501
        ...
        public static ClientMessage EncodeRequest(Hazelcast.CP.CPGroupId groupId, string name, long sessionId, long threadId, Guid invocationUid, int permits)
        {
            ...
            {
                IsRetryable = true,
                OperationName = "Semaphore.Change"
            };
