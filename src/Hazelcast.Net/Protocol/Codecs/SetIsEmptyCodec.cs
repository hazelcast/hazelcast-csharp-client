...
namespace Hazelcast.Protocol.Codecs
{
    ...
    ///</summary>
#if SERVER_CODEC
    internal static class SetIsEmptyServerCodec
#else
    internal static class SetIsEmptyCodec
#endif
    {
        public const int RequestMessageType = 396544; // 0x060D00
        public const int ResponseMessageType = 396545; // 0x060D01
