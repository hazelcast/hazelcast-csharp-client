...
namespace Hazelcast.Protocol.Codecs
{
    ...
    ///</summary>
#if SERVER_CODEC
    internal static class ListGetAllServerCodec
#else
    internal static class ListGetAllCodec
#endif
    {
        public const int RequestMessageType = 330240; // 0x050A00
        public const int ResponseMessageType = 330241; // 0x050A01
