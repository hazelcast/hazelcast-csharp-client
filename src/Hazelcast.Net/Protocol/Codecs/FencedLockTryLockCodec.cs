...
namespace Hazelcast.Protocol.Codecs
{
    ...
    ///</summary>
#if SERVER_CODEC
    internal static class FencedLockTryLockServerCodec
#else
    internal static class FencedLockTryLockCodec
#endif
    {
        public const int RequestMessageType = 459264; // 0x070200
        public const int ResponseMessageType = 459265; // 0x070201
        ...
        public static ClientMessage EncodeRequest(Hazelcast.CP.CPGroupId groupId, string name, long sessionId, long threadId, Guid invocationUid, long timeoutMs)
        {
            var clientMessage = new ClientMessage
            {
                IsRetryable = true,
                OperationName = "FencedLock.TryLock"
            };
