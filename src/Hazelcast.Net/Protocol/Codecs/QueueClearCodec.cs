...
namespace Hazelcast.Protocol.Codecs
{
    ...
    ///</summary>
#if SERVER_CODEC
    internal static class QueueClearServerCodec
#else
    internal static class QueueClearCodec
#endif
    {
        public const int RequestMessageType = 200448; // 0x030F00
        public const int ResponseMessageType = 200449; // 0x030F01
