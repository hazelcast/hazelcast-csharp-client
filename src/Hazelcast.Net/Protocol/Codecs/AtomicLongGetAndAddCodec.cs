...
namespace Hazelcast.Protocol.Codecs
{
    ...
    ///</summary>
#if SERVER_CODEC
    internal static class AtomicLongGetAndAddServerCodec
#else
    internal static class AtomicLongGetAndAddCodec
#endif
    {
        public const int RequestMessageType = 591360; // 0x090600
        public const int ResponseMessageType = 591361; // 0x090601
        ...
        public static ClientMessage EncodeRequest(Hazelcast.CP.CPGroupId groupId, string name, long delta)
        {
            ...
            {
                IsRetryable = false,
                OperationName = "AtomicLong.GetAndAdd"
            };
