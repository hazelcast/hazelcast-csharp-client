...
namespace Hazelcast.Protocol.Codecs
{
...
#endif
    {
        ...
        public static ClientMessage EncodeRequest(string name, string inMemoryFormat, bool asyncFillup, bool statisticsEnabled, string mergePolicy, ICollection<Hazelcast.Protocol.Models.ListenerConfigHolder> listenerConfigs, string splitBrainProtectionName, int mergeBatchSize, string @namespace)
        {
