...
namespace Hazelcast.Protocol.Codecs
{
...
#endif
    {
        ...
        public sealed class ResponseParameters
        {
            ...
            ///</summary>
            public IList<int> AltoPorts { get; set; }

            /// <summary>
            /// <c>true</c> if the altoPorts is received from the member, <c>false</c> otherwise.
            /// If this is false, altoPorts has the default value for its type.
            /// </summary>
            public bool IsAltoPortsExists { get; set; }
        }

#if SERVER_CODEC
        public static ClientMessage EncodeResponse(byte status, Hazelcast.Networking.NetworkAddress address, Guid memberUuid, byte serializationVersion, string serverHazelcastVersion, int partitionCount, Guid clusterId, bool failoverSupported, ICollection<int> altoPorts=null)
        {
            var clientMessage = new ClientMessage();
        ...
        public static ResponseParameters DecodeResponse(ClientMessage clientMessage)
        {
            ...
            else response.IsAltoPortsExists = false;
            return response;
        }
