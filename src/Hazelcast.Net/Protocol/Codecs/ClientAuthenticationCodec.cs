...
namespace Hazelcast.Protocol.Codecs
{
...
#endif
    {
        ...
        private const int RequestInitialFrameSize = RequestRoutingModeFieldOffset + BytesExtensions.SizeOfByte;
        ...
        public static ClientMessage EncodeRequest(string clusterName, string username, string password, Guid uuid, string clientType, byte serializationVersion, string clientHazelcastVersion, string clientName, ICollection<string> labels, byte routingMode)
        {
