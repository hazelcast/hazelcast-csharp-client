...
namespace Hazelcast.Protocol.Codecs
{
    ...
    ///</summary>
#if SERVER_CODEC
    internal static class TransactionalMapReplaceServerCodec
#else
    internal static class TransactionalMapReplaceCodec
#endif
    {
        public const int RequestMessageType = 919808; // 0x0E0900
        public const int ResponseMessageType = 919809; // 0x0E0901
        ...
        public static ClientMessage EncodeRequest(string name, Guid txnId, long threadId, IData key, IData @value)
        {
            ...
            {
                IsRetryable = false,
                OperationName = "TransactionalMap.Replace"
            };
