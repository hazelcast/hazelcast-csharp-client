...
namespace Hazelcast.Protocol.Codecs
{
    ...
    ///</summary>
#if SERVER_CODEC
    internal static class CountDownLatchGetRoundServerCodec
#else
    internal static class CountDownLatchGetRoundCodec
#endif
    {
        public const int RequestMessageType = 722176; // 0x0B0500
        public const int ResponseMessageType = 722177; // 0x0B0501
        ...
        public static ClientMessage EncodeRequest(Hazelcast.CP.CPGroupId groupId, string name)
        {
            ...
            {
                IsRetryable = true,
                OperationName = "CountDownLatch.GetRound"
            };
