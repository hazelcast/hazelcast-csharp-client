...
namespace Hazelcast.Protocol.Codecs
{
...
#endif
    {
        ...
        public static ClientMessage EncodeRequest(string name, ICollection<Hazelcast.Protocol.Models.ListenerConfigHolder> listenerConfigs, int backupCount, int asyncBackupCount, int maxSize, bool statisticsEnabled, string splitBrainProtectionName, string mergePolicy, int mergeBatchSize)
        {
