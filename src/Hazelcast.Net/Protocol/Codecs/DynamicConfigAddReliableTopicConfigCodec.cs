...
namespace Hazelcast.Protocol.Codecs
{
...
#endif
    {
        ...
        public static ClientMessage EncodeRequest(string name, ICollection<Hazelcast.Protocol.Models.ListenerConfigHolder> listenerConfigs, int readBatchSize, bool statisticsEnabled, string topicOverloadPolicy, IData executor, string @namespace)
        {
