...
namespace Hazelcast.Protocol.Codecs
{
    ...
    ///</summary>
#if SERVER_CODEC
    internal static class SemaphoreAvailablePermitsServerCodec
#else
    internal static class SemaphoreAvailablePermitsCodec
#endif
    {
        public const int RequestMessageType = 787968; // 0x0C0600
        public const int ResponseMessageType = 787969; // 0x0C0601
