...
namespace Hazelcast.Protocol.Codecs
{
    ...
    ///</summary>
#if SERVER_CODEC
    internal static class TransactionalSetAddServerCodec
#else
    internal static class TransactionalSetAddCodec
#endif
    {
        public const int RequestMessageType = 1048832; // 0x100100
        public const int ResponseMessageType = 1048833; // 0x100101
        ...
        public static ClientMessage EncodeRequest(string name, Guid txnId, long threadId, IData item)
        {
            ...
            {
                IsRetryable = false,
                OperationName = "TransactionalSet.Add"
            };
