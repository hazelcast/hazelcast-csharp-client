...
namespace Hazelcast.Protocol.Codecs
{
...
#endif
    {
        ...
        public static ClientMessage EncodeRequest(string name, int capacity, int backupCount, int asyncBackupCount, int timeToLiveSeconds, string inMemoryFormat, Hazelcast.Protocol.Models.RingbufferStoreConfigHolder ringbufferStoreConfig, string splitBrainProtectionName, string mergePolicy, int mergeBatchSize)
        {
