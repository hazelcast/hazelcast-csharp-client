...
{
    public partial interface IHReplicatedDictionary<TKey, TValue> // Events
    {
        /// <summary>
        ...
        Task<Guid> SubscribeAsync(Action<ReplicatedDictionaryEventHandlers<TKey, TValue>> handle);
        ...
        /// <param name="handle">An event handlers collection builder.</param>
        /// <returns>The unique identifier of the subscription.</returns>
        Task<Guid> SubscribeAsync(TKey key, Action<ReplicatedDictionaryEventHandlers<TKey, TValue>> handle);
        ...
        /// <param name="handle">An event handlers collection builder.</param>
        /// <returns>The unique identifier of the subscription.</returns>
        Task<Guid> SubscribeAsync(IPredicate predicate, Action<ReplicatedDictionaryEventHandlers<TKey, TValue>> handle);
        ...
        /// <param name="handle">An event handlers collection builder.</param>
        /// <returns>The unique identifier of the subscription.</returns>
        Task<Guid> SubscribeAsync(TKey key, IPredicate predicate, Action<ReplicatedDictionaryEventHandlers<TKey, TValue>> handle);
