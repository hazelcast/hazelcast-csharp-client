...
{
    internal sealed class DictionaryEntryMergedEventHandler<TKey, TValue, TSender> : DictionaryEntryEventHandlerBase<TKey, TValue, TSender, DictionaryEntryMergedEventArgs<TKey, TValue>>
    {
        public DictionaryEntryMergedEventHandler(Func<TSender, DictionaryEntryMergedEventArgs<TKey, TValue>, ValueTask> handler)
