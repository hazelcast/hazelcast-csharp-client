...
{
    internal sealed class DictionaryEntryEvictedEventHandler<TKey, TValue, TSender> : DictionaryEntryEventHandlerBase<TKey, TValue, TSender, DictionaryEntryEvictedEventArgs<TKey, TValue>>
    {
        public DictionaryEntryEvictedEventHandler(Func<TSender, DictionaryEntryEvictedEventArgs<TKey, TValue>, ValueTask> handler)
