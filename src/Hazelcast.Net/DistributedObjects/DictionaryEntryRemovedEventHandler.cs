...
{
    internal sealed class DictionaryEntryRemovedEventHandler<TKey, TValue, TSender> : DictionaryEntryEventHandlerBase<TKey, TValue, TSender, DictionaryEntryRemovedEventArgs<TKey, TValue>>
    {
        public DictionaryEntryRemovedEventHandler(Func<TSender, DictionaryEntryRemovedEventArgs<TKey, TValue>, ValueTask> handler)
