...
{
    internal sealed class DictionaryEntryAddedEventHandler<TKey, TValue, TSender> : DictionaryEntryEventHandlerBase<TKey, TValue, TSender, DictionaryEntryAddedEventArgs<TKey, TValue>>
    {
        public DictionaryEntryAddedEventHandler(Func<TSender, DictionaryEntryAddedEventArgs<TKey, TValue>, ValueTask> handler)
