...
namespace Hazelcast.DistributedObjects
{
    internal sealed class MapClearedEventHandler<TKey, TValue, TSender> : MapEventHandlerBase<TKey, TValue, TSender, MapClearedEventArgs>
    {
        ...
        protected override MapClearedEventArgs CreateEventArgs(MemberInfo member, int numberOfAffectedEntries, object state)
            => new MapClearedEventArgs(member, numberOfAffectedEntries, state);
    }
}
