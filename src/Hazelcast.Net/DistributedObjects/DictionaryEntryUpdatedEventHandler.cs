...
{
    internal sealed class DictionaryEntryUpdatedEventHandler<TKey, TValue, TSender> : DictionaryEntryEventHandlerBase<TKey, TValue, TSender, DictionaryEntryUpdatedEventArgs<TKey, TValue>>
    {
        public DictionaryEntryUpdatedEventHandler(Func<TSender, DictionaryEntryUpdatedEventArgs<TKey, TValue>, ValueTask> handler)
