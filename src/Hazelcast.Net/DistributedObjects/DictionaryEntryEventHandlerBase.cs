...
namespace Hazelcast.DistributedObjects
{
    ...
    internal abstract class DictionaryEntryEventHandlerBase<TKey, TValue, TSender, TArgs> : IDictionaryEntryEventHandler<TKey, TValue, TSender>
    {
        private readonly Func<TSender, TArgs, ValueTask> _handler;

        protected DictionaryEntryEventHandlerBase(HDictionaryEventTypes eventType, Func<TSender, TArgs, ValueTask> handler)
        {
            EventType = eventType;
            _handler = handler;
        }
