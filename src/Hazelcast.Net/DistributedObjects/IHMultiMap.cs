...
namespace Hazelcast.DistributedObjects
{
    ...
    public interface IHMultiMap<TKey, TValue> : IDistributedObject
    {
        ...
        Task<bool> ContainsEntryAsync(TKey key, TValue value, TimeSpan timeout = default);
        Task<bool> ContainsEntryAsync(TKey key, TValue value, CancellationToken cancellationToken);
