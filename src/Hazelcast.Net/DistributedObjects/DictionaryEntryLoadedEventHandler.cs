...
{
    internal sealed class DictionaryEntryLoadedEventHandler<TKey, TValue, TSender> : DictionaryEntryEventHandlerBase<TKey, TValue, TSender, DictionaryEntryLoadedEventArgs<TKey, TValue>>
    {
        public DictionaryEntryLoadedEventHandler(Func<TSender, DictionaryEntryLoadedEventArgs<TKey, TValue>, ValueTask> handler)
