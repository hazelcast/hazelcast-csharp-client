...
{
    internal sealed class DictionaryEntryInvalidatedEventHandler<TKey, TValue, TSender> : DictionaryEntryEventHandlerBase<TKey, TValue, TSender, DictionaryEntryInvalidatedEventArgs<TKey, TValue>>
    {
        public DictionaryEntryInvalidatedEventHandler(Func<TSender, DictionaryEntryInvalidatedEventArgs<TKey, TValue>, ValueTask> handler)
