...
namespace Hazelcast.Aggregation
{
    ...
    /// </remarks>
    internal sealed class LongSumAggregator : AggregatorBase<long>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LongSumAggregator"/> class.
        /// </summary>
        ...
        /// <inheritdoc />
        public override int ClassId => AggregatorDataSerializerHook.LongSum;
    }
}
