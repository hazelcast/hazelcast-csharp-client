...
namespace Hazelcast.Aggregation
{
    ...
    /// </remarks>
    internal sealed class DoubleSumAggregator : AggregatorBase<double>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DoubleSumAggregator"/> class.
        /// </summary>
        ...
        /// <inheritdoc />
        public override int ClassId => AggregatorDataSerializerHook.DoubleSum;
    }
}
