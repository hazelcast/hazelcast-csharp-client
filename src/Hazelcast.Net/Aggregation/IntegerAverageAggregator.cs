...
namespace Hazelcast.Aggregation
{
    ...
    /// </remarks>
    internal sealed class IntegerAverageAggregator : AggregatorBase<double>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IntegerAverageAggregator"/> class.
        /// </summary>
        ...
        /// <inheritdoc />
        public override int ClassId => AggregatorDataSerializerHook.IntAvg;
    }
}
