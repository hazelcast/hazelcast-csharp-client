...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="TopicOverloadException"/> class.
    /// </summary>
    public TopicOverloadException()
    { }

    /// <summary>
    /// Initializes a new instance of the <see cref="TopicOverloadException"/> class with a specified error message.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="TopicOverloadException"/> class with a reference to
    /// the inner exception that is the cause of this exception.
    /// </summary>
    /// <param name="innerException">The exception that is the cause of the current exception, or a null
    /// reference if no inner exception is specified.</param>
    public TopicOverloadException(Exception innerException) : base(innerException)
    { }
