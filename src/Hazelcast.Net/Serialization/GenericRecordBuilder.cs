...
/// <summary>
/// Creates new <see cref="IGenericRecordBuilder"/> instances.
/// </summary>
public static class GenericRecordBuilder
{
    /// <summary>
    /// Creates a new <see cref="IGenericRecordBuilder"/> for a compact-serialized
    /// generic record with the specified typename.
    /// </summary>
