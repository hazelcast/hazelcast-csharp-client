...
namespace Hazelcast.Predicates
{
    ...
    public static class Query
    {
        ...
        public static PredicateBuilder WhereKey()
        ...
        /// </summary>
        /// <returns>A predicate builder.</returns>
        public static PredicateBuilder WhereValue()
        ...
        /// <returns>A predicate builder.</returns>
        public static PredicateBuilder WhereKey(string name)
        {
        ...
        /// <param name="name">The name of the attribute.</param>
        /// <returns>A predicate builder.</returns>
        public static PredicateBuilder Where(string name)
        {
            if (string.IsNullOrWhiteSpace(name)) throw new ArgumentException(ExceptionMessages.NullOrEmpty, nameof(name));
        ...
        public static IPredicate WhereAll(params IPredicate[] predicates)
        ...
        /// <param name="predicates">The predicates.</param>
        /// <returns>A new predicate.</returns>
        public static IPredicate WhereAny(params IPredicate[] predicates)
        ...
        /// <returns>A new predicate.</returns>
        public static IPredicate WhereNot(IPredicate predicate)
