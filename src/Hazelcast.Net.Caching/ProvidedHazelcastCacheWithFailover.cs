...
internal class ProvidedHazelcastCacheWithFailover : HazelcastCache
{
    public ProvidedHazelcastCacheWithFailover(IOptions<HazelcastFailoverOptions> hazelcastFailoverOptions, IOptions<HazelcastCacheOptions> hazelcastCacheOptions)
        : base(
            hazelcastFailoverOptions?.Value ?? throw new ArgumentNullException(nameof(hazelcastFailoverOptions)),
