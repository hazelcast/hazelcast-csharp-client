...
namespace Hazelcast.Testing
{
    ...
    // warnings because directly using Is.Something would indeed be simpler. So... we do
    // not inherit from Is and instead copy the code in Ish.
    ...
    public abstract class Ish //: NUnit.Framework.Is
    {
        ...
        /// <summary>
        /// Returns a constraint that tests for a failed attempt.
        /// </summary>
        public static AttemptConstraint FailedAttempt()
            => new AttemptConstraint(false);

        /// <summary>
        /// Returns a constraint that tests for a failed attempt with a value.
        /// </summary>
        public static AttemptConstraint FailedAttempt<TResult>(TResult result)
            => new AttemptConstraint<TResult>(false, result);

        /// <summary>
        /// Returns a constraint that tests for a successful attempt.
        /// </summary>
        public static AttemptConstraint SuccessfulAttempt()
            => new AttemptConstraint(true);

        /// <summary>
        /// Returns a constraint that tests for a successful attempt with a value.
        /// </summary>
        public static AttemptConstraint SuccessfulAttempt<TResult>(TResult result)
            => new AttemptConstraint<TResult>(true, result);

        /// <summary>
        /// Returns a constraint that tests for an attempt.
        /// </summary>
        public static AttemptConstraint Attempt(bool success)
            => new AttemptConstraint(success);

        /// <summary>
        /// Returns a constraint that tests for an attempt with a value.
        /// </summary>
        public static AttemptConstraint Attempt<TResult>(bool success, TResult result)
            => new AttemptConstraint<TResult>(success, result);

        // all the code below is directly copied from NUnit
        //
        ...
        /// <summary>
        /// Returns a constraint that tests whether the path provided
        /// is a sub-path of the expected path after canonicalization.
        /// </summary>
