...
namespace Hazelcast.Tests.Configuration
{
    ...
    {
        [Test]
        public void ConfigurationExceptionConstructors()
        {
            _ = new ConfigurationException();
            _ = new ConfigurationException("exception");
            _ = new ConfigurationException(new Exception("bang"));
            var e = new ConfigurationException("exception", new Exception("bang"));
