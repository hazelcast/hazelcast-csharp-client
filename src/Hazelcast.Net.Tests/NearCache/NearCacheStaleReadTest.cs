...
//    [TestFixture]
//    [Category("3.10")]
//    public class NearCacheStaleReadTest : NearCacheTestBase
//    {
//        private static readonly ILogger Logger = Services.Get.LoggerFactory().CreateLogger<NearCacheStaleReadTest>();
...
//            if (!_stop.Get())
//            {
//                Logger.LogInformation("Problem did not occur within " + MaxRuntime + "s.");
//            }
//            _stop.Set(true);
//            threadPut.Join();
//            foreach (var thread in threads)
...
//                    Logger.LogWarning("Assertion violated! (valueMap = " + valueMap + ", i = " + i + ")");
...
//                    if (valueMap != i)
//                    {
//                        Logger.LogWarning("Near Cache invalidation lost! (valueMap = " + valueMap + ", i = " + i + ")");
//                        _failed.Set(true);
//                        _stop.Set(true);
//                    }
//                }
//            }
//            Logger.LogInformation(Thread.CurrentThread.Name + " performed " + i + " operations.");
//        }
...
//            }
//            Logger.LogInformation(Thread.CurrentThread.Name + " performed " + n + " operations.");
//        }
//    }
//}