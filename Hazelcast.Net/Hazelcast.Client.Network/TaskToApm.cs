...
//
// This file is a direct copy of the System.Threading.Tasks.TaskToApm internal
// class of the .NET Framework, available at
//
// https://referencesource.microsoft.com/#mscorlib/system/threading/Tasks/TaskToApm.cs
//
// and .NET Core, available at
//
// https://github.com/dotnet/runtime/blob/master/src/libraries/Common/src/System/Threading/Tasks/TaskToApm.cs
//
// It exists to enable us to manipulate the underlying tasks.
...
namespace Hazelcast.Client.Network
{
    ...
    internal static class TaskToApm
    {
        ...
        public static TResult End<TResult>(IAsyncResult asyncResult)
        {
            ...
            //throw new ArgumentNullException();
            var message = $"asyncResult is {asyncResult}";
            if (asyncResult is TaskAsyncResult twar2)
            {
                message += $" and task is {twar2._task}";
            }
            else
            {
                message += $", expecting {typeof(TaskAsyncResult)}";
            }
