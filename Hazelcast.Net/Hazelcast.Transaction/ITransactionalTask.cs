namespace Hazelcast.Transaction
{
    ...
    /// </remarks>
    /// <seealso cref="Hazelcast.Core.HazelcastInstance.ExecuteTransaction{T}(ITransactionalTask{T})">
    ///     Hazelcast.Core.IHazelcastInstance.ExecuteTransaction
    ///     &lt;T&gt;(ITransactionalTask&lt;T&gt;)
    /// </seealso>
    /// <seealso cref="Hazelcast.Core.HazelcastInstance.ExecuteTransaction{T}(TransactionOptions, ITransactionalTask{T})">
    ///     Hazelcast.Core.IHazelcastInstance.ExecuteTransaction
    ///     &lt;T&gt;(TransactionOptions, ITransactionalTask&lt;T&gt;)
    /// </seealso>
