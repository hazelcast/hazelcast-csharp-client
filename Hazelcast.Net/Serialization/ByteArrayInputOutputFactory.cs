...
namespace Hazelcast.Serialization
{
    internal sealed class ByteArrayInputOutputFactory : IInputOutputFactory
    {
        ...
        public ByteArrayInputOutputFactory(Endianness endianness)
        {
        ...
        {
            return new ByteArrayObjectDataInput(data.ToByteArray(), HeapData.DataOffset, service, _endianness);
        }

        public IBufferObjectDataInput CreateInput(byte[] buffer, ISerializationService service)
        {
            return new ByteArrayObjectDataInput(buffer, service, _endianness);
        }

        public IBufferObjectDataOutput CreateOutput(int size, ISerializationService service)
        {
            return new ByteArrayObjectDataOutput(size, service, _endianness);
        }
