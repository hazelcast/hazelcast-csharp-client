...
namespace Hazelcast.Client.Connection
{
    public class DummyClientConnectionManager : SmartClientConnectionManager
    {
        ...
        public DummyClientConnectionManager(HazelcastClient client, Authenticator authenticator,
            LoadBalancer loadBalancer) : base(client, authenticator, loadBalancer)
        {
        }
