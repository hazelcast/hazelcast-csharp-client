...
//
//             _client.ExecutionService.ScheduleWithFixedDelay(PeriodicStatisticsSendTask, _period, _period, _heartbeatToken.Token);
//
...
//         {
//             var ownerAddress = _client.ClusterService.GetOwnerConnectionAddress();
//             var clientConnection = _client.ConnectionManager.GetConnection(ownerAddress);
...
//         }
//
//         private void FillMetrics(StringBuilder stats, Connection ownerConnection)
//         {
...
//         {
//             foreach (var nearCache in _client.NearCacheManager.GetAllNearCaches())
//             {
