...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    {
        public const int RequestMessageType = 0x000800;
        public const int ResponseMessageType = 0x000801;
        private const int RequestInitialFrameSize = PartitionIdFieldOffset + IntSizeInBytes;
        private const int ResponsePartitionStateVersionFieldOffset = CorrelationIdFieldOffset + LongSizeInBytes;
        ...
        public static ClientMessage EncodeRequest() 
        {
            ...
            clientMessage.OperationName = "Client.GetPartitions";
