...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    ///</summary>
    internal static class CacheRemoveCodec 
    {
        public const int RequestMessageType = 0x151700;
        public const int ResponseMessageType = 0x151701;
        ...
        public static ClientMessage EncodeRequest(string name, IData key, IData currentValue, int completionId) 
        {
            var clientMessage = CreateForEncode();
            clientMessage.IsRetryable = false;
            clientMessage.AcquiresResource = false;
            clientMessage.OperationName = "Cache.Remove";
        ...
        public static CacheRemoveCodec.RequestParameters DecodeRequest(ClientMessage clientMessage) 
        {
            ...
            request.CurrentValue = CodecUtil.DecodeNullable(ref iterator, DataCodec.Decode);
            return request;
        }
