...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    /// TODO DOC
    ///</summary>
    internal static class CacheRemoveEntryListenerCodec 
    {
        public const int RequestMessageType = 0x151500;
        public const int ResponseMessageType = 0x151501;
        ...
        public static ClientMessage EncodeRequest(string name, Guid registrationId) 
        {
            ...
            clientMessage.OperationName = "Cache.RemoveEntryListener";
        ...
        public static CacheRemoveEntryListenerCodec.RequestParameters DecodeRequest(ClientMessage clientMessage) 
        {
        ...
        public static CacheRemoveEntryListenerCodec.ResponseParameters DecodeResponse(ClientMessage clientMessage)
        {
            var iterator = clientMessage.GetIterator();
