...
namespace Hazelcast.Client.Protocol.Codec
{
	internal sealed class MapPutIfAbsentCodec
	{
		...
		{
			int requiredDataSize = MapPutIfAbsentCodec.RequestParameters.CalculateDataSize(name, key, value, threadId, ttl);
		...
		{
			MapPutIfAbsentCodec.RequestParameters parameters = new MapPutIfAbsentCodec.RequestParameters();
			string name;
			name = null;
		...
		{
			int requiredDataSize = MapPutIfAbsentCodec.ResponseParameters.CalculateDataSize(response);
			ClientMessage clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
		...
		public static MapPutIfAbsentCodec.ResponseParameters DecodeResponse(ClientMessage clientMessage)
		{
			MapPutIfAbsentCodec.ResponseParameters parameters = new MapPutIfAbsentCodec.ResponseParameters();
			IData response;
			response = null;
