...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    ///</summary>
    internal static class DynamicConfigAddAtomicLongConfigCodec 
    {
        public const int RequestMessageType = 0x1E1300;
        public const int ResponseMessageType = 0x1E1301;
        ...
        public static ClientMessage EncodeRequest(string name, string splitBrainProtectionName, string mergePolicy, int mergeBatchSize) 
        {
            ...
            clientMessage.OperationName = "DynamicConfig.AddAtomicLongConfig";
