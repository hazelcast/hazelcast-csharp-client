...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    ///</summary>
    internal static class DurableExecutorSubmitToPartitionCodec 
    {
        public const int RequestMessageType = 0x1B0300;
        public const int ResponseMessageType = 0x1B0301;
        ...
        public static ClientMessage EncodeRequest(string name, IData callable) 
        {
            var clientMessage = CreateForEncode();
            clientMessage.IsRetryable = true;
            clientMessage.AcquiresResource = false;
            clientMessage.OperationName = "DurableExecutor.SubmitToPartition";
