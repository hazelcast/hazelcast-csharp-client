...
{
	internal sealed class ListContainsAllCodec
	{
		public static readonly ListMessageType RequestType = ListMessageType.ListContainsall;
		...
		{
			int requiredDataSize = ListContainsAllCodec.RequestParameters.CalculateDataSize(name, valueSet);
		...
		{
			ListContainsAllCodec.RequestParameters parameters = new ListContainsAllCodec.RequestParameters();
			string name;
			name = null;
		...
		{
			int requiredDataSize = ListContainsAllCodec.ResponseParameters.CalculateDataSize(response);
			ClientMessage clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
		...
		{
			ListContainsAllCodec.ResponseParameters parameters = new ListContainsAllCodec.ResponseParameters();
			bool response;
