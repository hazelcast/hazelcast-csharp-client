...
{
	internal sealed class MultiMapKeySetCodec
	{
		public static readonly MultiMapMessageType RequestType = MultiMapMessageType.MultimapKeyset;
		...
		{
			int requiredDataSize = MultiMapKeySetCodec.RequestParameters.CalculateDataSize(name);
		...
		{
			MultiMapKeySetCodec.RequestParameters parameters = new MultiMapKeySetCodec.RequestParameters();
			string name;
			name = null;
		...
		{
			int requiredDataSize = MultiMapKeySetCodec.ResponseParameters.CalculateDataSize(list);
			ClientMessage clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
		...
		{
			MultiMapKeySetCodec.ResponseParameters parameters = new MultiMapKeySetCodec.ResponseParameters();
			IList<IData> list;
			list = null;
