...
namespace Hazelcast.Client.Protocol.Codec
{
	internal sealed class ListCompareAndRemoveAllCodec
	{
		...
		{
			int requiredDataSize = ListCompareAndRemoveAllCodec.RequestParameters.CalculateDataSize(name, valueSet);
		...
		{
			ListCompareAndRemoveAllCodec.RequestParameters parameters = new ListCompareAndRemoveAllCodec.RequestParameters();
			string name;
			name = null;
		...
		{
			int requiredDataSize = ListCompareAndRemoveAllCodec.ResponseParameters.CalculateDataSize(response);
			ClientMessage clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
		...
		{
			ListCompareAndRemoveAllCodec.ResponseParameters parameters = new ListCompareAndRemoveAllCodec.ResponseParameters();
			bool response;
