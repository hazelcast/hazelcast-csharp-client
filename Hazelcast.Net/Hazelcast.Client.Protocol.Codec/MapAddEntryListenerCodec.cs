...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    {
        public const int RequestMessageType = 0x011C00;
        public const int ResponseMessageType = 0x011C01;
        private const int RequestIncludeValueFieldOffset = PartitionIdFieldOffset + IntSizeInBytes;
        private const int RequestListenerFlagsFieldOffset = RequestincludeValueFieldOffset + BooleanSizeInBytes;
        ...
        private const int EventEntryMessageType = 0x011C02;
