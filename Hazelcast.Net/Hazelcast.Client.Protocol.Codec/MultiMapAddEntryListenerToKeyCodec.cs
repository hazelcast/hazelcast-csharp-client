...
namespace Hazelcast.Client.Protocol.Codec
{
	internal sealed class MultiMapAddEntryListenerToKeyCodec
	{
		...
		{
			int requiredDataSize = MultiMapAddEntryListenerToKeyCodec.RequestParameters.CalculateDataSize(name, key, includeValue);
		...
		{
			MultiMapAddEntryListenerToKeyCodec.RequestParameters parameters = new MultiMapAddEntryListenerToKeyCodec.RequestParameters();
			string name;
			name = null;
		...
		{
			int requiredDataSize = MultiMapAddEntryListenerToKeyCodec.ResponseParameters.CalculateDataSize(response);
			ClientMessage clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
		...
		{
			MultiMapAddEntryListenerToKeyCodec.ResponseParameters parameters = new MultiMapAddEntryListenerToKeyCodec.ResponseParameters();
			string response;
			response = null;
