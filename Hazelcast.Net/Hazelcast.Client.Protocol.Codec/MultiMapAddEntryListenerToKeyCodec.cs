...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    {
        public const int RequestMessageType = 0x020D00;
        public const int ResponseMessageType = 0x020D01;
        private const int RequestIncludeValueFieldOffset = PartitionIdFieldOffset + IntSizeInBytes;
        private const int RequestLocalOnlyFieldOffset = RequestincludeValueFieldOffset + BooleanSizeInBytes;
        ...
        private const int EventEntrynumberOfAffectedEntriesFieldOffset = EventEntryuuidFieldOffset + UUIDSizeInBytes;
        private const int EventEntryInitialFrameSize = EventEntrynumberOfAffectedEntriesFieldOffset + IntSizeInBytes;
        private const int EventEntryMessageType = 0x020D02;
