...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    {
        private static int CalculateRequestDataSize(string name, IData key, bool localOnly)
        {
        ...
        internal static ClientMessage EncodeRequest(string name, IData key, bool localOnly)
        {
            var requiredDataSize = CalculateRequestDataSize(name, key, localOnly);
            var clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
            clientMessage.SetMessageType((int) ReplicatedMapMessageType.ReplicatedMapAddEntryListenerToKey);
