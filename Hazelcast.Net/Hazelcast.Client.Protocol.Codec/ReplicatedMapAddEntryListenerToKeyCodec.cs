...
{
	internal sealed class ReplicatedMapAddEntryListenerToKeyCodec
	{
		public static readonly ReplicatedMapMessageType RequestType = ReplicatedMapMessageType.ReplicatedmapAddentrylistenertokey;
		...
		{
			int requiredDataSize = ReplicatedMapAddEntryListenerToKeyCodec.RequestParameters.CalculateDataSize(name, key);
		...
		{
			ReplicatedMapAddEntryListenerToKeyCodec.RequestParameters parameters = new ReplicatedMapAddEntryListenerToKeyCodec.RequestParameters();
			string name;
			name = null;
		...
		{
			int requiredDataSize = ReplicatedMapAddEntryListenerToKeyCodec.ResponseParameters.CalculateDataSize(response);
			ClientMessage clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
		...
		{
			ReplicatedMapAddEntryListenerToKeyCodec.ResponseParameters parameters = new ReplicatedMapAddEntryListenerToKeyCodec.ResponseParameters();
			string response;
			response = null;
