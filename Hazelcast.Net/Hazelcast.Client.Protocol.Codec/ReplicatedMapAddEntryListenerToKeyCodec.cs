...
namespace Hazelcast.Client.Protocol.Codec
{
    internal sealed class ReplicatedMapAddEntryListenerToKeyCodec
    {
        public static readonly ReplicatedMapMessageType RequestType =
            ReplicatedMapMessageType.ReplicatedMapAddEntryListenerToKey;
        ...
        public class RequestParameters
        {
            ...
            public static int CalculateDataSize(string name, IData key, bool localOnly)
            {
        ...
        {
            var requiredDataSize = RequestParameters.CalculateDataSize(name, key, localOnly);
