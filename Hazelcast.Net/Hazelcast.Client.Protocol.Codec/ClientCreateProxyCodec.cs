...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    {
        public const int RequestMessageType = 0x000500;
        public const int ResponseMessageType = 0x000501;
        ...
        public static ClientMessage EncodeRequest(string name, string serviceName, com.hazelcast.nio.Address target) 
        {
        ...
        public static ClientCreateProxyCodec.RequestParameters DecodeRequest(ClientMessage clientMessage) 
        {
            ...
            request.Target = AddressCodec.Decode(ref iterator);
            return request;
        }
