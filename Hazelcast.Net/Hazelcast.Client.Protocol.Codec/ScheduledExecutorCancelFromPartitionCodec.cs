...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    {
        public const int RequestMessageType = 0x1D0900;
        public const int ResponseMessageType = 0x1D0901;
        private const int RequestMayInterruptIfRunningFieldOffset = PartitionIdFieldOffset + IntSizeInBytes;
        private const int RequestInitialFrameSize = RequestMayInterruptIfRunningFieldOffset + BooleanSizeInBytes;
