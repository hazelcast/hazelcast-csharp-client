...
{
	internal sealed class ReplicatedMapRemoveEntryListenerCodec
	{
		public static readonly ReplicatedMapMessageType RequestType = ReplicatedMapMessageType.ReplicatedmapRemoveentrylistener;
		...
		{
			int requiredDataSize = ReplicatedMapRemoveEntryListenerCodec.RequestParameters.CalculateDataSize(name, registrationId);
		...
		{
			ReplicatedMapRemoveEntryListenerCodec.RequestParameters parameters = new ReplicatedMapRemoveEntryListenerCodec.RequestParameters();
			string name;
			name = null;
		...
		{
			int requiredDataSize = ReplicatedMapRemoveEntryListenerCodec.ResponseParameters.CalculateDataSize(response);
			ClientMessage clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
		...
		{
			ReplicatedMapRemoveEntryListenerCodec.ResponseParameters parameters = new ReplicatedMapRemoveEntryListenerCodec.ResponseParameters();
			bool response;
