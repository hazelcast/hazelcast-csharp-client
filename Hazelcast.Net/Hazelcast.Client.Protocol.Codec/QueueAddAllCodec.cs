...
namespace Hazelcast.Client.Protocol.Codec
{
	internal sealed class QueueAddAllCodec
	{
		...
		{
			int requiredDataSize = QueueAddAllCodec.RequestParameters.CalculateDataSize(name, dataList);
		...
		{
			QueueAddAllCodec.RequestParameters parameters = new QueueAddAllCodec.RequestParameters();
			string name;
			name = null;
		...
		{
			int requiredDataSize = QueueAddAllCodec.ResponseParameters.CalculateDataSize(response);
			ClientMessage clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
		...
		{
			QueueAddAllCodec.ResponseParameters parameters = new QueueAddAllCodec.ResponseParameters();
			bool response;
