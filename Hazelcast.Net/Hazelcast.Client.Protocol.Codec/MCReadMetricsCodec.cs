...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    ///</summary>
    internal static class MCReadMetricsCodec 
    {
        //hex: 0x200100
        ...
        private const int RequestFromSequenceFieldOffset = RequestUuidFieldOffset + GuidSizeInBytes;
        private const int RequestInitialFrameSize = RequestFromSequenceFieldOffset + LongSizeInBytes;
        private const int ResponseNextSequenceFieldOffset = ResponseBackupAcksFieldOffset + IntSizeInBytes;
        ...
        public static ClientMessage EncodeRequest(Guid uuid, long fromSequence) 
        {
            ...
            clientMessage.OperationName = "MC.ReadMetrics";
        ...
        public class ResponseParameters 
        {
            ...
            ///</summary>
            public IList<KeyValuePair<long, byte[]>> Elements;
