...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    {
        public const int RequestMessageType = 0x151400;
        public const int ResponseMessageType = 0x151401;
        private const int RequestGetFieldOffset = PartitionIdFieldOffset + IntSizeInBytes;
        private const int RequestCompletionIdFieldOffset = RequestgetFieldOffset + BooleanSizeInBytes;
