...
{
	internal sealed class ReplicatedMapValuesCodec
	{
		public static readonly ReplicatedMapMessageType RequestType = ReplicatedMapMessageType.ReplicatedmapValues;
		...
		{
			int requiredDataSize = ReplicatedMapValuesCodec.RequestParameters.CalculateDataSize(name);
		...
		{
			ReplicatedMapValuesCodec.RequestParameters parameters = new ReplicatedMapValuesCodec.RequestParameters();
			string name;
			name = null;
		...
		{
			int requiredDataSize = ReplicatedMapValuesCodec.ResponseParameters.CalculateDataSize(list);
			ClientMessage clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
		...
		{
			ReplicatedMapValuesCodec.ResponseParameters parameters = new ReplicatedMapValuesCodec.ResponseParameters();
			IList<IData> list;
			list = null;
