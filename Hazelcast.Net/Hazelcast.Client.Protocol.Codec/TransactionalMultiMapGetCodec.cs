...
{
	internal sealed class TransactionalMultiMapGetCodec
	{
		public static readonly TransactionalMultiMapMessageType RequestType = TransactionalMultiMapMessageType.TransactionalmultimapGet;
		...
		{
			int requiredDataSize = TransactionalMultiMapGetCodec.RequestParameters.CalculateDataSize(name, txnId, threadId, key);
		...
		public static TransactionalMultiMapGetCodec.RequestParameters DecodeRequest(ClientMessage clientMessage)
		{
			TransactionalMultiMapGetCodec.RequestParameters parameters = new TransactionalMultiMapGetCodec.RequestParameters();
			string name;
			name = null;
		...
		{
			int requiredDataSize = TransactionalMultiMapGetCodec.ResponseParameters.CalculateDataSize(list);
			ClientMessage clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
		...
		{
			TransactionalMultiMapGetCodec.ResponseParameters parameters = new TransactionalMultiMapGetCodec.ResponseParameters();
			IList<IData> list;
			list = null;
