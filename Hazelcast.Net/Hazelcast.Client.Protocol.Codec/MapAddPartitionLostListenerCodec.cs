...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    {
        public const int RequestMessageType = 0x011F00;
        public const int ResponseMessageType = 0x011F01;
        ...
        private const int EventMapPartitionLostInitialFrameSize = EventMapPartitionLostuuidFieldOffset + UUIDSizeInBytes;
        private const int EventMapPartitionLostMessageType = 0x011F02;
        ...
        public abstract class AbstractEventHandler 
        {
            ...
            public abstract void HandleMapPartitionLostEvent(int partitionId, Guid uuid);
        }
    }
}