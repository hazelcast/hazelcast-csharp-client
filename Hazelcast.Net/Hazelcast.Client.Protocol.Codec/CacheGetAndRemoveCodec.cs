...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    {
        public const int RequestMessageType = 0x150B00;
        public const int ResponseMessageType = 0x150B01;
        ...
        public static ClientMessage EncodeRequest(string name, IData key, int completionId) 
        {
            var clientMessage = CreateForEncode();
            clientMessage.IsRetryable = false;
            clientMessage.AcquiresResource = false;
            clientMessage.OperationName = "Cache.GetAndRemove";
        ...
        public static CacheGetAndRemoveCodec.RequestParameters DecodeRequest(ClientMessage clientMessage) 
        {
        ...
        public static CacheGetAndRemoveCodec.ResponseParameters DecodeResponse(ClientMessage clientMessage)
        {
            var iterator = clientMessage.GetIterator();
