...
namespace Hazelcast.Client.Protocol.Codec
{
	internal sealed class MultiMapAddEntryListenerCodec
	{
		...
		{
			int requiredDataSize = MultiMapAddEntryListenerCodec.RequestParameters.CalculateDataSize(name, includeValue);
		...
		public static MultiMapAddEntryListenerCodec.RequestParameters DecodeRequest(ClientMessage clientMessage)
		{
			MultiMapAddEntryListenerCodec.RequestParameters parameters = new MultiMapAddEntryListenerCodec.RequestParameters();
			string name;
			name = null;
		...
		{
			int requiredDataSize = MultiMapAddEntryListenerCodec.ResponseParameters.CalculateDataSize(response);
			ClientMessage clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
		...
		{
			MultiMapAddEntryListenerCodec.ResponseParameters parameters = new MultiMapAddEntryListenerCodec.ResponseParameters();
			string response;
			response = null;
