...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    ///</summary>
    internal static class AtomicReferenceClearCodec 
    {
        public const int RequestMessageType = 0x0B0A00;
        public const int ResponseMessageType = 0x0B0A01;
        ...
        public static ClientMessage EncodeRequest(string name) 
        {
            ...
            clientMessage.OperationName = "AtomicReference.Clear";
