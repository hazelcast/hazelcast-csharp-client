...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    ///</summary>
    internal static class CacheRemovePartitionLostListenerCodec 
    {
        public const int RequestMessageType = 0x151B00;
        public const int ResponseMessageType = 0x151B01;
        ...
        public static ClientMessage EncodeRequest(string name, Guid registrationId) 
        {
            ...
            clientMessage.OperationName = "Cache.RemovePartitionLostListener";
        ...
        public static CacheRemovePartitionLostListenerCodec.ResponseParameters DecodeResponse(ClientMessage clientMessage)
        {
            var iterator = clientMessage.GetIterator();
