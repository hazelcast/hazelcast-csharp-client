...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    {
        private static int CalculateRequestDataSize(string name, IData entryProcessor)
        {
        ...
        internal static ClientMessage EncodeRequest(string name, IData entryProcessor)
        {
            var requiredDataSize = CalculateRequestDataSize(name, entryProcessor);
            var clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
            clientMessage.SetMessageType((int) MapMessageType.MapExecuteOnAllKeys);
