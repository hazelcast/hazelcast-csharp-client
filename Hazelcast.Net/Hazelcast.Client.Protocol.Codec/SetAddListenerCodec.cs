...
namespace Hazelcast.Client.Protocol.Codec
{
	internal sealed class SetAddListenerCodec
	{
		...
		{
			int requiredDataSize = SetAddListenerCodec.RequestParameters.CalculateDataSize(name, includeValue);
		...
		{
			SetAddListenerCodec.RequestParameters parameters = new SetAddListenerCodec.RequestParameters();
			string name;
			name = null;
		...
		{
			int requiredDataSize = SetAddListenerCodec.ResponseParameters.CalculateDataSize(response);
			ClientMessage clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
		...
		public static SetAddListenerCodec.ResponseParameters DecodeResponse(ClientMessage clientMessage)
		{
			SetAddListenerCodec.ResponseParameters parameters = new SetAddListenerCodec.ResponseParameters();
			string response;
			response = null;
