...
namespace Hazelcast.Client.Protocol.Codec
{
    internal sealed class ReplicatedMapAddEntryListenerWithPredicateCodec
    {
        public static readonly ReplicatedMapMessageType RequestType =
            ReplicatedMapMessageType.ReplicatedMapAddEntryListenerWithPredicate;
        ...
        public class RequestParameters
        {
            ...
            public static int CalculateDataSize(string name, IData predicate, bool localOnly)
            {
        ...
        {
            var requiredDataSize = RequestParameters.CalculateDataSize(name, predicate, localOnly);
