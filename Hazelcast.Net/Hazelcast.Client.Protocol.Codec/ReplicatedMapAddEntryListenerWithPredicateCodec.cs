...
{
	internal sealed class ReplicatedMapAddEntryListenerWithPredicateCodec
	{
		public static readonly ReplicatedMapMessageType RequestType = ReplicatedMapMessageType.ReplicatedmapAddentrylistenerwithpredicate;
		...
		{
			int requiredDataSize = ReplicatedMapAddEntryListenerWithPredicateCodec.RequestParameters.CalculateDataSize(name, predicate);
		...
		public static ReplicatedMapAddEntryListenerWithPredicateCodec.RequestParameters DecodeRequest(ClientMessage clientMessage)
		{
			ReplicatedMapAddEntryListenerWithPredicateCodec.RequestParameters parameters = new ReplicatedMapAddEntryListenerWithPredicateCodec.RequestParameters();
			string name;
			name = null;
		...
		{
			int requiredDataSize = ReplicatedMapAddEntryListenerWithPredicateCodec.ResponseParameters.CalculateDataSize(response);
			ClientMessage clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
		...
		public static ReplicatedMapAddEntryListenerWithPredicateCodec.ResponseParameters DecodeResponse(ClientMessage clientMessage)
		{
			ReplicatedMapAddEntryListenerWithPredicateCodec.ResponseParameters parameters = new ReplicatedMapAddEntryListenerWithPredicateCodec.ResponseParameters();
			string response;
			response = null;
