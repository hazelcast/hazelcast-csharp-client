...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    {
        private static int CalculateRequestDataSize(string name, IData predicate, bool localOnly)
        {
        ...
        internal static ClientMessage EncodeRequest(string name, IData predicate, bool localOnly)
        {
            var requiredDataSize = CalculateRequestDataSize(name, predicate, localOnly);
            var clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
            clientMessage.SetMessageType((int) ReplicatedMapMessageType.ReplicatedMapAddEntryListenerWithPredicate);
