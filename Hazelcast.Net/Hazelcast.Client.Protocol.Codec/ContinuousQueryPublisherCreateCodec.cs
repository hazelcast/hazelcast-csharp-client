...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    /// TODO DOC
    ///</summary>
    internal static class ContinuousQueryPublisherCreateCodec 
    {
        //hex: 0x180200
        public const int RequestMessageType = 1573376;
        //hex: 0x180201
        public const int ResponseMessageType = 1573377;
        ...
        private const int RequestCoalesceFieldOffset = RequestPopulateFieldOffset + BoolSizeInBytes;
        private const int RequestInitialFrameSize = RequestCoalesceFieldOffset + BoolSizeInBytes;
        ...
        public static ClientMessage EncodeRequest(string mapName, string cacheName, IData predicate, int batchSize, int bufferSize, long delaySeconds, bool populate, bool coalesce) 
        {
            ...
            clientMessage.OperationName = "ContinuousQuery.PublisherCreate";
