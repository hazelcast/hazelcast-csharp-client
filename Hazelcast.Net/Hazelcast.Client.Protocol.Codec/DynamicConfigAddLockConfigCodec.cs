...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    ///</summary>
    internal static class DynamicConfigAddLockConfigCodec 
    {
        public const int RequestMessageType = 0x1E0400;
        public const int ResponseMessageType = 0x1E0401;
        ...
        public static ClientMessage EncodeRequest(string name, string splitBrainProtectionName) 
        {
            var clientMessage = CreateForEncode();
            clientMessage.IsRetryable = false;
            clientMessage.AcquiresResource = false;
            clientMessage.OperationName = "DynamicConfig.AddLockConfig";
