...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    {
        public const int RequestMessageType = 0x1E0700;
        public const int ResponseMessageType = 0x1E0701;
        private const int RequestAsyncFillupFieldOffset = PartitionIdFieldOffset + IntSizeInBytes;
        private const int RequestStatisticsEnabledFieldOffset = RequestasyncFillupFieldOffset + BooleanSizeInBytes;
