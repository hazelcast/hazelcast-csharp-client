...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    {
        public const int RequestMessageType = 0x1E0500;
        public const int ResponseMessageType = 0x1E0501;
        ...
        public static ClientMessage EncodeRequest(string name, IEnumerable<com.hazelcast.client.impl.protocol.task.dynamicconfig.ListenerConfigHolder> listenerConfigs, int backupCount, int asyncBackupCount, int maxSize, bool statisticsEnabled, string splitBrainProtectionName, string mergePolicy, int mergeBatchSize) 
        {
            ...
            clientMessage.OperationName = "DynamicConfig.AddListConfig";
        ...
        public static DynamicConfigAddListConfigCodec.RequestParameters DecodeRequest(ClientMessage clientMessage) 
        {
        ...
        public static DynamicConfigAddListConfigCodec.ResponseParameters DecodeResponse(ClientMessage clientMessage)
        {
            var iterator = clientMessage.GetIterator();
