...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    ///</summary>
    internal static class DurableExecutorRetrieveResultCodec 
    {
        public const int RequestMessageType = 0x1B0400;
        public const int ResponseMessageType = 0x1B0401;
        ...
        public static ClientMessage EncodeRequest(string name, int sequence) 
        {
            ...
            clientMessage.OperationName = "DurableExecutor.RetrieveResult";
