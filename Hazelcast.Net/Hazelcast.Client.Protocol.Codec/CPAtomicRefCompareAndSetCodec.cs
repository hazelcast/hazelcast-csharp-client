...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    ///</summary>
    internal static class CPAtomicRefCompareAndSetCodec 
    {
        public const int RequestMessageType = 0x240200;
        public const int ResponseMessageType = 0x240201;
        ...
        public static ClientMessage EncodeRequest(Hazelcast.CP.RaftGroupId groupId, string name, IData oldValue, IData newValue) 
        {
            var clientMessage = ClientMessage.CreateForEncode();
            clientMessage.IsRetryable = false;
            clientMessage.AcquiresResource = false;
            clientMessage.OperationName = "CPAtomicRef.CompareAndSet";
