...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    {
        public const int RequestMessageType = 0x151100;
        public const int ResponseMessageType = 0x151101;
        private const int RequestReplaceExistingValuesFieldOffset = PartitionIdFieldOffset + IntSizeInBytes;
        private const int RequestInitialFrameSize = RequestReplaceExistingValuesFieldOffset + BooleanSizeInBytes;
        ...
        public static ClientMessage EncodeRequest(string name, IEnumerable<IData> keys, bool replaceExistingValues) 
        {
            ...
            clientMessage.OperationName = "Cache.LoadAll";
