...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    {
        public const int RequestMessageType = 0x090300;
        public const int ResponseMessageType = 0x090301;
        private const int RequestUuidFieldOffset = PartitionIdFieldOffset + IntSizeInBytes;
        private const int RequestInterruptFieldOffset = RequestuuidFieldOffset + UUIDSizeInBytes;
        private const int RequestInitialFrameSize = RequestInterruptFieldOffset + BooleanSizeInBytes;
        ...
        public static ClientMessage EncodeRequest(Guid uuid, bool interrupt) 
        {
            var clientMessage = CreateForEncode();
            clientMessage.IsRetryable = false;
            clientMessage.AcquiresResource = false;
            clientMessage.OperationName = "ExecutorService.CancelOnPartition";
