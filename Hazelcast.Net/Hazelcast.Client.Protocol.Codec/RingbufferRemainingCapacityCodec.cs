...
{
    internal sealed class RingbufferRemainingCapacityCodec
    {

        public static readonly RingbufferMessageType RequestType = RingbufferMessageType.RingbufferRemainingCapacity;
