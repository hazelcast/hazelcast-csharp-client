...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    ///</summary>
    internal static class ConditionAwaitCodec 
    {
        public const int RequestMessageType = 0x080100;
        public const int ResponseMessageType = 0x080101;
        ...
        public static ClientMessage EncodeRequest(string name, long threadId, long timeout, string lockName, long referenceId) 
        {
            ...
            clientMessage.OperationName = "Condition.Await";
