...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    ///</summary>
    internal static class AtomicReferenceSetAndGetCodec 
    {
        public const int RequestMessageType = 0x0B0C00;
        public const int ResponseMessageType = 0x0B0C01;
        ...
        public static ClientMessage EncodeRequest(string name, IData newValue) 
        {
            ...
            clientMessage.OperationName = "AtomicReference.SetAndGet";
