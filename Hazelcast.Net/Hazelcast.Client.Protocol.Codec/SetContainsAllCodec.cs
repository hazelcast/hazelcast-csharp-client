...
{
	internal sealed class SetContainsAllCodec
	{
		public static readonly SetMessageType RequestType = SetMessageType.SetContainsall;
		...
		{
			int requiredDataSize = SetContainsAllCodec.RequestParameters.CalculateDataSize(name, valueSet);
		...
		{
			SetContainsAllCodec.RequestParameters parameters = new SetContainsAllCodec.RequestParameters();
			string name;
			name = null;
		...
		{
			int requiredDataSize = SetContainsAllCodec.ResponseParameters.CalculateDataSize(response);
			ClientMessage clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
		...
		{
			SetContainsAllCodec.ResponseParameters parameters = new SetContainsAllCodec.ResponseParameters();
			bool response;
