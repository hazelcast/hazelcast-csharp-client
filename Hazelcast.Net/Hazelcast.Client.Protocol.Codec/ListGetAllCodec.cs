...
namespace Hazelcast.Client.Protocol.Codec
{
	internal sealed class ListGetAllCodec
	{
		...
		{
			int requiredDataSize = ListGetAllCodec.RequestParameters.CalculateDataSize(name);
		...
		{
			ListGetAllCodec.RequestParameters parameters = new ListGetAllCodec.RequestParameters();
			string name;
			name = null;
		...
		{
			int requiredDataSize = ListGetAllCodec.ResponseParameters.CalculateDataSize(list);
			ClientMessage clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
		...
		{
			ListGetAllCodec.ResponseParameters parameters = new ListGetAllCodec.ResponseParameters();
			IList<IData> list;
			list = null;
