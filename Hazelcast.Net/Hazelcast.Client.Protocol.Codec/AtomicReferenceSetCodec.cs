...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    ///</summary>
    internal static class AtomicReferenceSetCodec 
    {
        public const int RequestMessageType = 0x0B0900;
        public const int ResponseMessageType = 0x0B0901;
        ...
        public static ClientMessage EncodeRequest(string name, IData newValue) 
        {
            ...
            clientMessage.OperationName = "AtomicReference.Set";
