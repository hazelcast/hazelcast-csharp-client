...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    {
        public const int RequestMessageType = 0x170100;
        public const int ResponseMessageType = 0x170101;
        private const int RequestTransactionIdFieldOffset = PartitionIdFieldOffset + IntSizeInBytes;
        private const int RequestThreadIdFieldOffset = RequesttransactionIdFieldOffset + UUIDSizeInBytes;
