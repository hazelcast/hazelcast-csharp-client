...
{
	internal sealed class MapValuesWithPagingPredicateCodec
	{
		public static readonly MapMessageType RequestType = MapMessageType.MapValueswithpagingpredicate;
		...
		{
			int requiredDataSize = MapValuesWithPagingPredicateCodec.RequestParameters.CalculateDataSize(name, predicate);
		...
		{
			MapValuesWithPagingPredicateCodec.RequestParameters parameters = new MapValuesWithPagingPredicateCodec.RequestParameters();
			string name;
			name = null;
		...
		{
			int requiredDataSize = MapValuesWithPagingPredicateCodec.ResponseParameters.CalculateDataSize(map);
			ClientMessage clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
		...
		{
			MapValuesWithPagingPredicateCodec.ResponseParameters parameters = new MapValuesWithPagingPredicateCodec.ResponseParameters();
