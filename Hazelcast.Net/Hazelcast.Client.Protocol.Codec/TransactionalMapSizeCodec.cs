...
namespace Hazelcast.Client.Protocol.Codec
{
	...
	{
		public static readonly TransactionalMapMessageType RequestType = TransactionalMapMessageType.TransactionalmapSize;
		...
		{
			int requiredDataSize = TransactionalMapSizeCodec.RequestParameters.CalculateDataSize(name, txnId, threadId);
		...
		public static TransactionalMapSizeCodec.RequestParameters DecodeRequest(ClientMessage clientMessage)
		{
			TransactionalMapSizeCodec.RequestParameters parameters = new TransactionalMapSizeCodec.RequestParameters();
			string name;
			name = null;
		...
		{
			int requiredDataSize = TransactionalMapSizeCodec.ResponseParameters.CalculateDataSize(response);
			ClientMessage clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
		...
		{
			TransactionalMapSizeCodec.ResponseParameters parameters = new TransactionalMapSizeCodec.ResponseParameters();
			int response;
