...
{
    internal static class TransactionalMapValuesWithPredicateCodec
    {
        ...
        internal static ClientMessage EncodeRequest(string name, string txnId, long threadId, IData predicate)
        {
            ...
            clientMessage.SetMessageType((int) TransactionalMapMessageType.TransactionalMapValuesWithPredicate);
