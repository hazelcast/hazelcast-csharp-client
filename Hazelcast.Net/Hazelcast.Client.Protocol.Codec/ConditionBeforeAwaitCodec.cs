...
{
	internal sealed class ConditionBeforeAwaitCodec
	{
		public static readonly ConditionMessageType RequestType = ConditionMessageType.ConditionBeforeawait;
		...
		{
			int requiredDataSize = ConditionBeforeAwaitCodec.RequestParameters.CalculateDataSize(name, threadId, lockName);
		...
		{
			ConditionBeforeAwaitCodec.RequestParameters parameters = new ConditionBeforeAwaitCodec.RequestParameters();
			string name;
			name = null;
		...
		{
			int requiredDataSize = ConditionBeforeAwaitCodec.ResponseParameters.CalculateDataSize();
			ClientMessage clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
		...
		{
			ConditionBeforeAwaitCodec.ResponseParameters parameters = new ConditionBeforeAwaitCodec.ResponseParameters();
			return parameters;
		}
	}
}
