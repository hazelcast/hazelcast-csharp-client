...
{
	internal sealed class MapKeySetWithPredicateCodec
	{
		public static readonly MapMessageType RequestType = MapMessageType.MapKeysetwithpredicate;
		...
		{
			int requiredDataSize = MapKeySetWithPredicateCodec.RequestParameters.CalculateDataSize(name, predicate);
		...
		{
			MapKeySetWithPredicateCodec.RequestParameters parameters = new MapKeySetWithPredicateCodec.RequestParameters();
			string name;
			name = null;
		...
		{
			int requiredDataSize = MapKeySetWithPredicateCodec.ResponseParameters.CalculateDataSize(list);
			ClientMessage clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
		...
		{
			MapKeySetWithPredicateCodec.ResponseParameters parameters = new MapKeySetWithPredicateCodec.ResponseParameters();
			IList<IData> list;
			list = null;
