...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    ///</summary>
    internal static class CPAtomicRefContainsCodec 
    {
        public const int RequestMessageType = 0x240300;
        public const int ResponseMessageType = 0x240301;
        ...
        public static ClientMessage EncodeRequest(Hazelcast.CP.RaftGroupId groupId, string name, IData value) 
        {
            ...
            clientMessage.OperationName = "CPAtomicRef.Contains";
        ...
        public static CPAtomicRefContainsCodec.RequestParameters DecodeRequest(ClientMessage clientMessage) 
        {
            ...
            request.Value = CodecUtil.DecodeNullable(ref iterator, DataCodec.Decode);
            return request;
        }
        ...
        public static CPAtomicRefContainsCodec.ResponseParameters DecodeResponse(ClientMessage clientMessage)
        {
            var iterator = clientMessage.GetIterator();
