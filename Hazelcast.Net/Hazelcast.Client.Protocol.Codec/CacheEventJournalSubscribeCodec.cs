...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    {
        public const int RequestMessageType = 0x152100;
        public const int ResponseMessageType = 0x152101;
        private const int RequestInitialFrameSize = PartitionIdFieldOffset + IntSizeInBytes;
        private const int ResponseOldestSequenceFieldOffset = CorrelationIdFieldOffset + LongSizeInBytes;
        ...
        public static ClientMessage EncodeRequest(string name) 
        {
            ...
            clientMessage.OperationName = "Cache.EventJournalSubscribe";
