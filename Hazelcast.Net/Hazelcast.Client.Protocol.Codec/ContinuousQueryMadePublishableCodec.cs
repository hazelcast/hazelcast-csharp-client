...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    /// TODO DOC
    ///</summary>
    internal static class ContinuousQueryMadePublishableCodec 
    {
        public const int RequestMessageType = 0x180300;
        public const int ResponseMessageType = 0x180301;
        ...
        public static ClientMessage EncodeRequest(string mapName, string cacheName) 
        {
            ...
            clientMessage.OperationName = "ContinuousQuery.MadePublishable";
        ...
        public static ContinuousQueryMadePublishableCodec.RequestParameters DecodeRequest(ClientMessage clientMessage) 
        {
        ...
        public static ContinuousQueryMadePublishableCodec.ResponseParameters DecodeResponse(ClientMessage clientMessage)
        {
            var iterator = clientMessage.GetIterator();
