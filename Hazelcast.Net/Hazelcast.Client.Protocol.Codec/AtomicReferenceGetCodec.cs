...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    ///</summary>
    internal static class AtomicReferenceGetCodec 
    {
        public const int RequestMessageType = 0x0B0800;
        public const int ResponseMessageType = 0x0B0801;
        ...
        public static ClientMessage EncodeRequest(string name) 
        {
            ...
            clientMessage.OperationName = "AtomicReference.Get";
