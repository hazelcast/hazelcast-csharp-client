...
{
    internal sealed class AtomicLongIncrementAndGetCodec
    {
        public static readonly AtomicLongMessageType RequestType = AtomicLongMessageType.AtomicLongIncrementAndGet;
