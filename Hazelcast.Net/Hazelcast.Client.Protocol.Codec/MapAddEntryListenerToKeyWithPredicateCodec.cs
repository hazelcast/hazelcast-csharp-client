...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    {
        private static int CalculateRequestDataSize(string name, IData key, IData predicate, bool includeValue, int listenerFlags,
            bool localOnly)
        {
        ...
        internal static ClientMessage EncodeRequest(string name, IData key, IData predicate, bool includeValue, int listenerFlags,
            bool localOnly)
        {
            var requiredDataSize = CalculateRequestDataSize(name, key, predicate, includeValue, listenerFlags, localOnly);
            var clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
            clientMessage.SetMessageType((int) MapMessageType.MapAddEntryListenerToKeyWithPredicate);
