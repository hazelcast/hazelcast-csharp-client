...
namespace Hazelcast.Client.Protocol.Codec
{
	internal sealed class MapAddEntryListenerToKeyWithPredicateCodec
	{
		...
		{
			int requiredDataSize = MapAddEntryListenerToKeyWithPredicateCodec.RequestParameters.CalculateDataSize(name, key, predicate, includeValue);
		...
		{
			MapAddEntryListenerToKeyWithPredicateCodec.RequestParameters parameters = new MapAddEntryListenerToKeyWithPredicateCodec.RequestParameters();
			string name;
			name = null;
		...
		{
			int requiredDataSize = MapAddEntryListenerToKeyWithPredicateCodec.ResponseParameters.CalculateDataSize(response);
			ClientMessage clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
		...
		{
			MapAddEntryListenerToKeyWithPredicateCodec.ResponseParameters parameters = new MapAddEntryListenerToKeyWithPredicateCodec.ResponseParameters();
			string response;
			response = null;
		...
		public class AbstractEventHandler
		{
			public static void Handle(ClientMessage clientMessage, HandleDelegate handle)
			{
                ...
                Logger.GetLogger(typeof(MapAddEntryListenerToKeyWithPredicateCodec)).Warning("Unknown message type received on event handler :" + clientMessage.GetMessageType());
			}
