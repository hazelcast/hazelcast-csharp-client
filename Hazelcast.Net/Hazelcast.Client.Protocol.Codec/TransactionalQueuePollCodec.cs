...
namespace Hazelcast.Client.Protocol.Codec
{
    internal static class TransactionalQueuePollCodec
    {
        ...
        internal static ClientMessage EncodeRequest(string name, string txnId, long threadId, long timeout)
        {
            var requiredDataSize = CalculateRequestDataSize(name, txnId, threadId, timeout);
            var clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
            clientMessage.SetMessageType((int) TransactionalQueueMessageType.TransactionalQueuePoll);
