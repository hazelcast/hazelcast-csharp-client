...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    ///</summary>
    internal static class CPAtomicLongGetAndAddCodec 
    {
        public const int RequestMessageType = 0x230600;
        public const int ResponseMessageType = 0x230601;
        ...
        public static ClientMessage EncodeRequest(Hazelcast.CP.RaftGroupId groupId, string name, long delta) 
        {
            ...
            clientMessage.OperationName = "CPAtomicLong.GetAndAdd";
        ...
        public static CPAtomicLongGetAndAddCodec.RequestParameters DecodeRequest(ClientMessage clientMessage) 
        {
        ...
        public static CPAtomicLongGetAndAddCodec.ResponseParameters DecodeResponse(ClientMessage clientMessage)
        {
            var iterator = clientMessage.GetIterator();
