...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    /// TODO DOC
    ///</summary>
    internal static class ExecutorServiceSubmitToPartitionCodec 
    {
        public const int RequestMessageType = 0x090500;
        public const int ResponseMessageType = 0x090501;
        ...
        public static ClientMessage EncodeRequest(string name, Guid uuid, IData callable) 
        {
            var clientMessage = CreateForEncode();
            clientMessage.IsRetryable = false;
            clientMessage.AcquiresResource = false;
            clientMessage.OperationName = "ExecutorService.SubmitToPartition";
