...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    ///</summary>
    internal static class CacheGetAndReplaceCodec 
    {
        public const int RequestMessageType = 0x150C00;
        public const int ResponseMessageType = 0x150C01;
        ...
        public static ClientMessage EncodeRequest(string name, IData key, IData value, IData expiryPolicy, int completionId) 
        {
            ...
            clientMessage.OperationName = "Cache.GetAndReplace";
