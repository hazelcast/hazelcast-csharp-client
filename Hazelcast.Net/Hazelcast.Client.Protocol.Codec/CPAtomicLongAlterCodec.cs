...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    ///</summary>
    internal static class CPAtomicLongAlterCodec 
    {
        public const int RequestMessageType = 0x230200;
        public const int ResponseMessageType = 0x230201;
        ...
        public static ClientMessage EncodeRequest(Hazelcast.CP.RaftGroupId groupId, string name, IData function, int returnValueType) 
        {
            ...
            clientMessage.OperationName = "CPAtomicLong.Alter";
