...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    {
        public const int RequestMessageType = 0x180400;
        public const int ResponseMessageType = 0x180401;
        ...
        private const int EventQueryCacheSingleMessageType = 0x180402;
        ...
        private const int EventQueryCacheBatchMessageType = 0x180403;
        ...
        public static ClientMessage EncodeQueryCacheBatchEvent(IEnumerable<com.hazelcast.map.impl.querycache.event.QueryCacheEventData> events, string source, int partitionId) 
        {
            var clientMessage = CreateForEncode();
        ...
        public abstract class AbstractEventHandler 
        {
            public void Handle(ClientMessage clientMessage) 
            {
                ...
                if (messageType == EventQueryCacheSingleMessageType) {
                    //empty initial frame
                    iterator.Next();
                    com.hazelcast.map.impl.querycache.event.DefaultQueryCacheEventData data = QueryCacheEventDataCodec.Decode(ref iterator);
                ...
                if (messageType == EventQueryCacheBatchMessageType) {
                    ...
                    IEnumerable<com.hazelcast.map.impl.querycache.event.DefaultQueryCacheEventData> events = ListMultiFrameCodec.Decode(ref iterator, QueryCacheEventDataCodec.Decode);
            ...
            public abstract void HandleQueryCacheBatchEvent(IEnumerable<com.hazelcast.map.impl.querycache.event.QueryCacheEventData> events, string source, int partitionId);
        }
    }
}