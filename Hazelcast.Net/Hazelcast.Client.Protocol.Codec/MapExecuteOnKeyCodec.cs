...
namespace Hazelcast.Client.Protocol.Codec
{
	internal sealed class MapExecuteOnKeyCodec
	{
		...
		{
			int requiredDataSize = MapExecuteOnKeyCodec.RequestParameters.CalculateDataSize(name, entryProcessor, key);
		...
		{
			MapExecuteOnKeyCodec.RequestParameters parameters = new MapExecuteOnKeyCodec.RequestParameters();
			string name;
			name = null;
		...
		{
			int requiredDataSize = MapExecuteOnKeyCodec.ResponseParameters.CalculateDataSize(response);
			ClientMessage clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
		...
		public static MapExecuteOnKeyCodec.ResponseParameters DecodeResponse(ClientMessage clientMessage)
		{
			MapExecuteOnKeyCodec.ResponseParameters parameters = new MapExecuteOnKeyCodec.ResponseParameters();
			IData response;
			response = null;
