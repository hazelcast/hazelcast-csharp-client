...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    {
        public const int RequestMessageType = 0x150700;
        public const int ResponseMessageType = 0x150701;
        private const int RequestCreateAlsoOnOthersFieldOffset = PartitionIdFieldOffset + IntSizeInBytes;
        private const int RequestInitialFrameSize = RequestCreateAlsoOnOthersFieldOffset + BooleanSizeInBytes;
