...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    {
        public const int RequestMessageType = 0x160200;
        public const int ResponseMessageType = 0x160201;
        ...
        public static ClientMessage EncodeRequest() 
        {
            ...
            clientMessage.OperationName = "XATransaction.CollectTransactions";
        ...
        public static XATransactionCollectTransactionsCodec.ResponseParameters DecodeResponse(ClientMessage clientMessage)
        {
            ...
            //empty initial frame
            iterator.Next();
            response.Response = ListMultiFrameCodec.Decode(ref iterator, XidCodec.Decode);
            return response;
        }
    }
}