...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    ///</summary>
    internal static class CPAtomicLongGetAndSetCodec 
    {
        public const int RequestMessageType = 0x230700;
        public const int ResponseMessageType = 0x230701;
        ...
        public static ClientMessage EncodeRequest(Hazelcast.CP.RaftGroupId groupId, string name, long newValue) 
        {
            ...
            clientMessage.OperationName = "CPAtomicLong.GetAndSet";
        ...
        public static CPAtomicLongGetAndSetCodec.RequestParameters DecodeRequest(ClientMessage clientMessage) 
        {
        ...
        public static CPAtomicLongGetAndSetCodec.ResponseParameters DecodeResponse(ClientMessage clientMessage)
        {
            var iterator = clientMessage.GetIterator();
