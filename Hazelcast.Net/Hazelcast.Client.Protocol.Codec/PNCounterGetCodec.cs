...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    {
        public const int RequestMessageType = 0x200100;
        public const int ResponseMessageType = 0x200101;
        private const int RequestInitialFrameSize = PartitionIdFieldOffset + IntSizeInBytes;
        private const int ResponseValueFieldOffset = CorrelationIdFieldOffset + LongSizeInBytes;
        ...
        public static ClientMessage EncodeRequest(string name, IEnumerable<KeyValuePair<Guid, long>> replicaTimestamps, com.hazelcast.nio.Address targetReplica) 
        {
