...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    ///</summary>
    internal static class CacheFetchNearCacheInvalidationMetadataCodec 
    {
        public const int RequestMessageType = 0x151F00;
        public const int ResponseMessageType = 0x151F01;
        ...
        public static ClientMessage EncodeRequest(IEnumerable<string> names, com.hazelcast.nio.Address address) 
        {
            var clientMessage = CreateForEncode();
            clientMessage.IsRetryable = false;
            clientMessage.AcquiresResource = false;
            clientMessage.OperationName = "Cache.FetchNearCacheInvalidationMetadata";
