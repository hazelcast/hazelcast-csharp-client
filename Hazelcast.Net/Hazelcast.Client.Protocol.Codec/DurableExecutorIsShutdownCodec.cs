...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    ///</summary>
    internal static class DurableExecutorIsShutdownCodec 
    {
        public const int RequestMessageType = 0x1B0200;
        public const int ResponseMessageType = 0x1B0201;
        ...
        public static ClientMessage EncodeRequest(string name) 
        {
            ...
            clientMessage.OperationName = "DurableExecutor.IsShutdown";
