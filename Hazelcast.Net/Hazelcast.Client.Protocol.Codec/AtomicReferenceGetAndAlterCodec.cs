...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    ///</summary>
    internal static class AtomicReferenceGetAndAlterCodec 
    {
        public const int RequestMessageType = 0x0B0400;
        public const int ResponseMessageType = 0x0B0401;
        ...
        public static ClientMessage EncodeRequest(string name, IData function) 
        {
            ...
            clientMessage.OperationName = "AtomicReference.GetAndAlter";
