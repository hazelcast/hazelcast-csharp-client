...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    ///</summary>
    internal static class CPAtomicLongGetCodec 
    {
        public const int RequestMessageType = 0x230500;
        public const int ResponseMessageType = 0x230501;
        ...
        public static ClientMessage EncodeRequest(Hazelcast.CP.RaftGroupId groupId, string name) 
        {
            ...
            clientMessage.OperationName = "CPAtomicLong.Get";
        ...
        public static CPAtomicLongGetCodec.RequestParameters DecodeRequest(ClientMessage clientMessage) 
        {
        ...
        public static CPAtomicLongGetCodec.ResponseParameters DecodeResponse(ClientMessage clientMessage)
        {
            var iterator = clientMessage.GetIterator();
