...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    ///</summary>
    internal static class ScheduledExecutorDisposeFromPartitionCodec 
    {
        public const int RequestMessageType = 0x1D1100;
        public const int ResponseMessageType = 0x1D1101;
        ...
        public static ClientMessage EncodeRequest(string schedulerName, string taskName) 
        {
            ...
            clientMessage.OperationName = "ScheduledExecutor.DisposeFromPartition";
