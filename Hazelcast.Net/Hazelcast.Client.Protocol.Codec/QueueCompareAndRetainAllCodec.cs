...
{
	internal sealed class QueueCompareAndRetainAllCodec
	{
		public static readonly QueueMessageType RequestType = QueueMessageType.QueueCompareandretainall;
		...
		{
			int requiredDataSize = QueueCompareAndRetainAllCodec.RequestParameters.CalculateDataSize(name, dataList);
		...
		{
			QueueCompareAndRetainAllCodec.RequestParameters parameters = new QueueCompareAndRetainAllCodec.RequestParameters();
			string name;
			name = null;
		...
		{
			int requiredDataSize = QueueCompareAndRetainAllCodec.ResponseParameters.CalculateDataSize(response);
			ClientMessage clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
		...
		{
			QueueCompareAndRetainAllCodec.ResponseParameters parameters = new QueueCompareAndRetainAllCodec.ResponseParameters();
			bool response;
