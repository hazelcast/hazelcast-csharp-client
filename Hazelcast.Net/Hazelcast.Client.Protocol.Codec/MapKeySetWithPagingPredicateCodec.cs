...
namespace Hazelcast.Client.Protocol.Codec
{
	internal sealed class MapKeySetWithPagingPredicateCodec
	{
		...
		{
			int requiredDataSize = MapKeySetWithPagingPredicateCodec.RequestParameters.CalculateDataSize(name, predicate);
		...
		{
			MapKeySetWithPagingPredicateCodec.RequestParameters parameters = new MapKeySetWithPagingPredicateCodec.RequestParameters();
			string name;
			name = null;
		...
		{
			int requiredDataSize = MapKeySetWithPagingPredicateCodec.ResponseParameters.CalculateDataSize(map);
			ClientMessage clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
		...
		{
			MapKeySetWithPagingPredicateCodec.ResponseParameters parameters = new MapKeySetWithPagingPredicateCodec.ResponseParameters();
