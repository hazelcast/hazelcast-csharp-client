...
{
	internal sealed class MapValuesCodec
	{
		public static readonly MapMessageType RequestType = MapMessageType.MapValues;
		...
		{
			int requiredDataSize = MapValuesCodec.RequestParameters.CalculateDataSize(name);
		...
		{
			MapValuesCodec.RequestParameters parameters = new MapValuesCodec.RequestParameters();
			string name;
			name = null;
		...
		{
			int requiredDataSize = MapValuesCodec.ResponseParameters.CalculateDataSize(list);
			ClientMessage clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
		...
		{
			MapValuesCodec.ResponseParameters parameters = new MapValuesCodec.ResponseParameters();
			IList<IData> list;
			list = null;
