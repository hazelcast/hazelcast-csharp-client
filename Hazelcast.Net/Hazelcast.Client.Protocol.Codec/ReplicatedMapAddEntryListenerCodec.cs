...
namespace Hazelcast.Client.Protocol.Codec
{
	...
	{
		public static readonly ReplicatedMapMessageType RequestType = ReplicatedMapMessageType.ReplicatedmapAddentrylistener;
		...
		{
			int requiredDataSize = ReplicatedMapAddEntryListenerCodec.RequestParameters.CalculateDataSize(name);
		...
		{
			ReplicatedMapAddEntryListenerCodec.RequestParameters parameters = new ReplicatedMapAddEntryListenerCodec.RequestParameters();
			string name;
			name = null;
		...
		{
			int requiredDataSize = ReplicatedMapAddEntryListenerCodec.ResponseParameters.CalculateDataSize(response);
			ClientMessage clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
		...
		{
			ReplicatedMapAddEntryListenerCodec.ResponseParameters parameters = new ReplicatedMapAddEntryListenerCodec.ResponseParameters();
			string response;
			response = null;
