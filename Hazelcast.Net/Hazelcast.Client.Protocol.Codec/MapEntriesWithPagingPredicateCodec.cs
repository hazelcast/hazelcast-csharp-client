...
namespace Hazelcast.Client.Protocol.Codec
{
	internal sealed class MapEntriesWithPagingPredicateCodec
	{
		...
		{
			int requiredDataSize = MapEntriesWithPagingPredicateCodec.RequestParameters.CalculateDataSize(name, predicate);
		...
		{
			MapEntriesWithPagingPredicateCodec.RequestParameters parameters = new MapEntriesWithPagingPredicateCodec.RequestParameters();
			string name;
			name = null;
		...
		{
			int requiredDataSize = MapEntriesWithPagingPredicateCodec.ResponseParameters.CalculateDataSize(map);
			ClientMessage clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
		...
		{
			MapEntriesWithPagingPredicateCodec.ResponseParameters parameters = new MapEntriesWithPagingPredicateCodec.ResponseParameters();
