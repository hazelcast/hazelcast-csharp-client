...
namespace Hazelcast.Client.Protocol.Codec
{
	internal sealed class ListIsEmptyCodec
	{
		...
		{
			int requiredDataSize = ListIsEmptyCodec.RequestParameters.CalculateDataSize(name);
		...
		{
			ListIsEmptyCodec.RequestParameters parameters = new ListIsEmptyCodec.RequestParameters();
			string name;
			name = null;
		...
		{
			int requiredDataSize = ListIsEmptyCodec.ResponseParameters.CalculateDataSize(response);
			ClientMessage clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
		...
		{
			ListIsEmptyCodec.ResponseParameters parameters = new ListIsEmptyCodec.ResponseParameters();
			bool response;
