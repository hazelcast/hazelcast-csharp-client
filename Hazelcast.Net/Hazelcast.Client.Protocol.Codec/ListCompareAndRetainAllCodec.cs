...
namespace Hazelcast.Client.Protocol.Codec
{
	internal sealed class ListCompareAndRetainAllCodec
	{
		...
		{
			int requiredDataSize = ListCompareAndRetainAllCodec.RequestParameters.CalculateDataSize(name, valueSet);
		...
		{
			ListCompareAndRetainAllCodec.RequestParameters parameters = new ListCompareAndRetainAllCodec.RequestParameters();
			string name;
			name = null;
		...
		{
			int requiredDataSize = ListCompareAndRetainAllCodec.ResponseParameters.CalculateDataSize(response);
			ClientMessage clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
		...
		{
			ListCompareAndRetainAllCodec.ResponseParameters parameters = new ListCompareAndRetainAllCodec.ResponseParameters();
			bool response;
