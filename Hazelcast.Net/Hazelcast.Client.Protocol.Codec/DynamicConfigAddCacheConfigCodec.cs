...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    {
        public const int RequestMessageType = 0x1E1000;
        public const int ResponseMessageType = 0x1E1001;
        private const int RequestStatisticsEnabledFieldOffset = PartitionIdFieldOffset + IntSizeInBytes;
        private const int RequestManagementEnabledFieldOffset = RequeststatisticsEnabledFieldOffset + BooleanSizeInBytes;
        private const int RequestReadThroughFieldOffset = RequestmanagementEnabledFieldOffset + BooleanSizeInBytes;
        private const int RequestWriteThroughFieldOffset = RequestreadThroughFieldOffset + BooleanSizeInBytes;
        private const int RequestBackupCountFieldOffset = RequestwriteThroughFieldOffset + BooleanSizeInBytes;
        ...
        private const int RequestInitialFrameSize = RequestDisablePerEntryInvalidationEventsFieldOffset + BooleanSizeInBytes;
