...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    ///</summary>
    internal static class SemaphoreChangeCodec 
    {
        public const int RequestMessageType = 0x0D0500;
        public const int ResponseMessageType = 0x0D0501;
        ...
        public static ClientMessage EncodeRequest(Hazelcast.CP.RaftGroupId groupId, string name, long sessionId, long threadId, Guid invocationUid, int permits) 
        {
            var clientMessage = CreateForEncode();
            clientMessage.IsRetryable = true;
            clientMessage.AcquiresResource = false;
            clientMessage.OperationName = "Semaphore.Change";
        ...
        public static SemaphoreChangeCodec.ResponseParameters DecodeResponse(ClientMessage clientMessage)
        {
            var iterator = clientMessage.GetIterator();
