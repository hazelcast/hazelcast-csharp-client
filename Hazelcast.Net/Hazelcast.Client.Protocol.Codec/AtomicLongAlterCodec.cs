...
namespace Hazelcast.Client.Protocol.Codec
{
	internal sealed class AtomicLongAlterCodec
	{
		...
		{
			int requiredDataSize = AtomicLongAlterCodec.RequestParameters.CalculateDataSize(name, function);
		...
		{
			AtomicLongAlterCodec.RequestParameters parameters = new AtomicLongAlterCodec.RequestParameters();
			string name;
			name = null;
		...
		{
			int requiredDataSize = AtomicLongAlterCodec.ResponseParameters.CalculateDataSize(response);
			ClientMessage clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
		...
		{
			AtomicLongAlterCodec.ResponseParameters parameters = new AtomicLongAlterCodec.ResponseParameters();
			long response;
