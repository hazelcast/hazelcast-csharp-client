...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    /// TODO DOC
    ///</summary>
    internal static class CacheAddInvalidationListenerCodec 
    {
        public const int RequestMessageType = 0x150200;
        public const int ResponseMessageType = 0x150201;
        ...
        private const int EventCacheInvalidationpartitionUuidFieldOffset = EventCacheInvalidationsourceUuidFieldOffset + UUIDSizeInBytes;
        private const int EventCacheInvalidationsequenceFieldOffset = EventCacheInvalidationpartitionUuidFieldOffset + UUIDSizeInBytes;
        private const int EventCacheInvalidationInitialFrameSize = EventCacheInvalidationsequenceFieldOffset + LongSizeInBytes;
        private const int EventCacheInvalidationMessageType = 0x150202;
        private const int EventCacheBatchInvalidationInitialFrameSize = PartitionIdFieldOffset + IntSizeInBytes;
        private const int EventCacheBatchInvalidationMessageType = 0x150203;
        ...
        public static ClientMessage EncodeRequest(string name, bool localOnly) 
        {
            ...
            clientMessage.OperationName = "Cache.AddInvalidationListener";
