...
namespace Hazelcast.Client.Protocol.Codec
{
	internal sealed class MultiMapRemoveEntryListenerCodec
	{
		...
		{
			int requiredDataSize = MultiMapRemoveEntryListenerCodec.RequestParameters.CalculateDataSize(name, registrationId);
		...
		{
			MultiMapRemoveEntryListenerCodec.RequestParameters parameters = new MultiMapRemoveEntryListenerCodec.RequestParameters();
			string name;
			name = null;
		...
		{
			int requiredDataSize = MultiMapRemoveEntryListenerCodec.ResponseParameters.CalculateDataSize(response);
			ClientMessage clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
		...
		{
			MultiMapRemoveEntryListenerCodec.ResponseParameters parameters = new MultiMapRemoveEntryListenerCodec.ResponseParameters();
			bool response;
