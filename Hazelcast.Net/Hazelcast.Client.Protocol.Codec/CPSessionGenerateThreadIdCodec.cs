...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    {
        public const int RequestMessageType = 0x220400;
        public const int ResponseMessageType = 0x220401;
        ...
        public static ClientMessage EncodeRequest(Hazelcast.CP.RaftGroupId groupId) 
        {
            var clientMessage = CreateForEncode();
            clientMessage.IsRetryable = true;
            clientMessage.AcquiresResource = false;
            clientMessage.OperationName = "CPSession.GenerateThreadId";
