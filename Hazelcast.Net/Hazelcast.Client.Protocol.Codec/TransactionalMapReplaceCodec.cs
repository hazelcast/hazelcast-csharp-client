...
namespace Hazelcast.Client.Protocol.Codec
{
	internal sealed class TransactionalMapReplaceCodec
	{
		...
		{
			int requiredDataSize = TransactionalMapReplaceCodec.RequestParameters.CalculateDataSize(name, txnId, threadId, key, value);
		...
		{
			TransactionalMapReplaceCodec.RequestParameters parameters = new TransactionalMapReplaceCodec.RequestParameters();
			string name;
			name = null;
		...
		{
			int requiredDataSize = TransactionalMapReplaceCodec.ResponseParameters.CalculateDataSize(response);
			ClientMessage clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
		...
		{
			TransactionalMapReplaceCodec.ResponseParameters parameters = new TransactionalMapReplaceCodec.ResponseParameters();
			IData response;
			response = null;
