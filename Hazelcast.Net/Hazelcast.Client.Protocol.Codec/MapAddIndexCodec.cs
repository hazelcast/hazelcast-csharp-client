...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    {
        //hex: 0x012D00
        public const int RequestMessageType = 77056;
        //hex: 0x012D01
        public const int ResponseMessageType = 77057;
        ...
        public static ClientMessage EncodeRequest(string name, com.hazelcast.config.IndexConfig indexConfig) 
        {
        ...
        public static MapAddIndexCodec.RequestParameters DecodeRequest(ClientMessage clientMessage) 
        {
            ...
            request.IndexConfig = IndexConfigCodec.Decode(ref iterator);
            return request;
        }
