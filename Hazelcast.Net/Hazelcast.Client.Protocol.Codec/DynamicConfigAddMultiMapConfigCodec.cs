...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    {
        public const int RequestMessageType = 0x1E0100;
        public const int ResponseMessageType = 0x1E0101;
        private const int RequestBinaryFieldOffset = PartitionIdFieldOffset + IntSizeInBytes;
        private const int RequestBackupCountFieldOffset = RequestbinaryFieldOffset + BooleanSizeInBytes;
