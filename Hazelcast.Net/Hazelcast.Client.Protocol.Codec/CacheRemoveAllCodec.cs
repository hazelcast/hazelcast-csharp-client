...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    ///</summary>
    internal static class CacheRemoveAllCodec 
    {
        public const int RequestMessageType = 0x150500;
        public const int ResponseMessageType = 0x150501;
        ...
        public static ClientMessage EncodeRequest(string name, int completionId) 
        {
            ...
            clientMessage.OperationName = "Cache.RemoveAll";
