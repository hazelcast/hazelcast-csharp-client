...
namespace Hazelcast.Client.Protocol.Codec
{
	internal sealed class TransactionalMapKeySetWithPredicateCodec
	{
		...
		{
			int requiredDataSize = TransactionalMapKeySetWithPredicateCodec.RequestParameters.CalculateDataSize(name, txnId, threadId, predicate);
		...
		{
			TransactionalMapKeySetWithPredicateCodec.RequestParameters parameters = new TransactionalMapKeySetWithPredicateCodec.RequestParameters();
			string name;
			name = null;
		...
		{
			int requiredDataSize = TransactionalMapKeySetWithPredicateCodec.ResponseParameters.CalculateDataSize(list);
			ClientMessage clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
		...
		{
			TransactionalMapKeySetWithPredicateCodec.ResponseParameters parameters = new TransactionalMapKeySetWithPredicateCodec.ResponseParameters();
