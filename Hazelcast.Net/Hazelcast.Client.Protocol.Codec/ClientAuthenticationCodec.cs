...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    {
        public const int RequestMessageType = 0x000200;
        public const int ResponseMessageType = 0x000201;
        ...
        public static ClientMessage EncodeRequest(string username, string password, Guid uuid, Guid ownerUuid, bool isOwnerConnection, string clientType, byte serializationVersion, string clientHazelcastVersion, string clientName, IEnumerable<string> labels, int partitionCount, Guid clusterId) 
        {
