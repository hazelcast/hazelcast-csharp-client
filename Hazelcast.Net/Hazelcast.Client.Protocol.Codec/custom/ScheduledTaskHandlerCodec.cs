...
namespace Hazelcast.Client.Protocol.Codec.Custom
{
    ...
    * and regenerate it.
    */
    internal static class ScheduledTaskHandlerCodec 
    {
        private const int PartitionIdFieldOffset = 0;
        ...
        public static void Encode(ClientMessage clientMessage, com.hazelcast.scheduledexecutor.ScheduledTaskHandler scheduledTaskHandler) 
        {
            ...
            EncodeInt(initialFrame.Content, PartitionIdFieldOffset, scheduledTaskHandler.PartitionId);
            clientMessage.Add(initialFrame);

            CodecUtil.EncodeNullable(clientMessage, scheduledTaskHandler.Address, AddressCodec.Encode);
        ...
        public static com.hazelcast.scheduledexecutor.impl.ScheduledTaskHandlerImpl Decode(ref FrameIterator iterator) 
        {
            // begin frame
            iterator.Next();
            ...
            var address = CodecUtil.DecodeNullable(ref iterator, AddressCodec.Decode);
            var schedulerName = StringCodec.Decode(ref iterator);
            var taskName = StringCodec.Decode(ref iterator);
