...
namespace Hazelcast.Client.Protocol.Codec.Custom
{
    ...
    */
    internal static class MerkleTreeConfigCodec 
    {
        ...
        private const int DepthFieldOffset = EnabledFieldOffset + BooleanSizeInBytes;
        private const int InitialFrameSize = DepthFieldOffset + IntSizeInBytes;
        ...
        public static void Encode(ClientMessage clientMessage, com.hazelcast.config.MerkleTreeConfig merkleTreeConfig) 
        {
            ...
            EncodeBool(initialFrame.Content, EnabledFieldOffset, merkleTreeConfig.IsEnabled);
            EncodeInt(initialFrame.Content, DepthFieldOffset, merkleTreeConfig.Depth);
            clientMessage.Add(initialFrame);

            clientMessage.Add(EndFrame);
        }

        public static com.hazelcast.config.MerkleTreeConfig Decode(ref FrameIterator iterator) 
        {
            // begin frame
            iterator.Next();
            ...
            var depth = DecodeInt(initialFrame.Content, DepthFieldOffset);
