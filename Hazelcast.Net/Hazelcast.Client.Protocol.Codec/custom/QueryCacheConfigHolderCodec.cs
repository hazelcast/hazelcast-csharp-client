...
namespace Hazelcast.Client.Protocol.Codec.Custom
{
    ...
    */
    internal static class QueryCacheConfigHolderCodec 
    {
        ...
        private const int PopulateFieldOffset = IncludeValueFieldOffset + BooleanSizeInBytes;
        private const int CoalesceFieldOffset = PopulateFieldOffset + BooleanSizeInBytes;
        private const int InitialFrameSize = CoalesceFieldOffset + BooleanSizeInBytes;
        ...
        public static com.hazelcast.client.impl.protocol.task.dynamicconfig.QueryCacheConfigHolder Decode(ref FrameIterator iterator) 
        {
            ...
            var indexConfigs = ListMultiFrameCodec.DecodeNullable(ref iterator, MapIndexConfigCodec.Decode);
