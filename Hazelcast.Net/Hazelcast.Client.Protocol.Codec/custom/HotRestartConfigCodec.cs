...
namespace Hazelcast.Client.Protocol.Codec.Custom
{
    ...
    */
    internal static class HotRestartConfigCodec 
    {
        ...
        private const int FsyncFieldOffset = EnabledFieldOffset + BooleanSizeInBytes;
        private const int InitialFrameSize = FsyncFieldOffset + BooleanSizeInBytes;
        ...
        public static void Encode(ClientMessage clientMessage, com.hazelcast.config.HotRestartConfig hotRestartConfig) 
        {
            ...
            EncodeBool(initialFrame.Content, EnabledFieldOffset, hotRestartConfig.IsEnabled);
            EncodeBool(initialFrame.Content, FsyncFieldOffset, hotRestartConfig.IsFsync);
            clientMessage.Add(initialFrame);

            clientMessage.Add(EndFrame);
        }

        public static com.hazelcast.config.HotRestartConfig Decode(ref FrameIterator iterator) 
        {
            // begin frame
            iterator.Next();
            ...
            var fsync = DecodeBool(initialFrame.Content, FsyncFieldOffset);
