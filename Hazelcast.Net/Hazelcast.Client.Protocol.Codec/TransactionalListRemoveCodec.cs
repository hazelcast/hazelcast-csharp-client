...
namespace Hazelcast.Client.Protocol.Codec
{
    internal sealed class TransactionalListRemoveCodec
    {
        ...
        public static readonly TransactionalListMessageType RequestType =
            TransactionalListMessageType.TransactionalListRemove;
        ...
        {
            var requiredDataSize = RequestParameters.CalculateDataSize(name, txnId, threadId, item);
