...
namespace Hazelcast.Client.Protocol.Codec
{
    ...
    */
    ...
    ///</summary>
    internal static class DurableExecutorRetrieveAndDisposeResultCodec 
    {
        public const int RequestMessageType = 0x1B0600;
        public const int ResponseMessageType = 0x1B0601;
        ...
        public static ClientMessage EncodeRequest(string name, int sequence) 
        {
            ...
            clientMessage.OperationName = "DurableExecutor.RetrieveAndDisposeResult";
