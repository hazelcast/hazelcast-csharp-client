...
{
	internal sealed class ReplicatedMapEntrySetCodec
	{
		public static readonly ReplicatedMapMessageType RequestType = ReplicatedMapMessageType.ReplicatedmapEntryset;
		...
		{
			int requiredDataSize = ReplicatedMapEntrySetCodec.RequestParameters.CalculateDataSize(name);
		...
		{
			ReplicatedMapEntrySetCodec.RequestParameters parameters = new ReplicatedMapEntrySetCodec.RequestParameters();
			string name;
			name = null;
		...
		{
			int requiredDataSize = ReplicatedMapEntrySetCodec.ResponseParameters.CalculateDataSize(map);
			ClientMessage clientMessage = ClientMessage.CreateForEncode(requiredDataSize);
		...
		{
			ReplicatedMapEntrySetCodec.ResponseParameters parameters = new ReplicatedMapEntrySetCodec.ResponseParameters();
