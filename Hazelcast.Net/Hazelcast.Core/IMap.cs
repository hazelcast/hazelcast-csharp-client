...
namespace Hazelcast.Core
{
    ...
    /// change the actual value in the map. One should put modified value back to make changes visible to all nodes.
    ...
    public interface IMap<K, V> : IDistributedObject
    {
        ...
        /// Removes the mapping for a key from this map if it is present
        /// (optional operation).
        /// <p> this operation does not return removed value to avoid serialization cost of returned value.
        ...
        /// </remarks>
        /// <param name="key">key</param>
        /// <returns> previous value associated with <c>key</c> or <c>null</c>
