...
namespace Hazelcast.DistributedObjects
{
    ...
    internal sealed class MapEntryUpdatedEventHandler<TKey, TValue> : MapEntryEventHandlerBase<TKey, TValue, MapEntryUpdatedEventArgs<TKey, TValue>>
    {
        ...
        protected override MapEntryUpdatedEventArgs<TKey, TValue> CreateEventArgs(MemberInfo member, Lazy<TKey> key, Lazy<TValue> value, Lazy<TValue> oldValue, Lazy<TValue> mergingValue, MapEventType eventType, int numberOfAffectedEntries)
            => new MapEntryUpdatedEventArgs<TKey, TValue>(member, key, oldValue, value);
    }

    public static partial class Extensions
    {
        public static MapEvents<TKey, TValue> EntryUpdated<TKey, TValue>(this MapEvents<TKey, TValue> events, Action<IMap<TKey, TValue>, MapEntryUpdatedEventArgs<TKey, TValue>> handler)
        {
            events.Handlers.Add(new MapEntryUpdatedEventHandler<TKey, TValue>(handler));
            return events;
        }
    }
}