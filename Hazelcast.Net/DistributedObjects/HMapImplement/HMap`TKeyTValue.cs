...
namespace Hazelcast.DistributedObjects.HMapImplement
{
    ...
    internal partial class HMap<TKey, TValue> : DistributedObjectBase, IHMap<TKey, TValue>
    {
        ...
        public HMap(string name, Cluster cluster, ISerializationService serializationService, ISequence<long> lockReferenceIdSequence, ILoggerFactory logggerFactory)
            : base(DistributedObjects.HMap.ServiceName, name, cluster, serializationService, logggerFactory)
        {
