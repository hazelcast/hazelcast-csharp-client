...
namespace Hazelcast.DistributedObjects.CachedMapImplement
{
    /// <summary>
    ...
    internal class CachedMap<TKey, TValue> : HMap<TKey, TValue>
    {
        private readonly NearCacheBase _cache;

        /// <summary>
        /// Initializes a new version of the <see cref="CachedMap{TKey,TValue}"/> class.
        /// </summary>
