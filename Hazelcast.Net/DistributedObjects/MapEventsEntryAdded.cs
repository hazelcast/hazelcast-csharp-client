...
namespace Hazelcast.DistributedObjects
{
    ...
    {
        public static MapEvents<TKey, TValue> EntryAdded<TKey, TValue>(this MapEvents<TKey, TValue> events, Action<IMap<TKey, TValue>, MapEntryAddedEventArgs<TKey, TValue>> handler)
        {
