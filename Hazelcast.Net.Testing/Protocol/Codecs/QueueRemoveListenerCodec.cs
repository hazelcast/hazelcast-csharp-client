...
namespace Hazelcast.Protocol.Codecs
{
    ...
    ///</summary>
    internal static class QueueRemoveListenerServerCodec
    {
        public const int RequestMessageType = 201216; // 0x031200
        public const int ResponseMessageType = 201217; // 0x031201
        ...
        public static ClientMessage EncodeRequest(string name, Guid registrationId)
        {
            ...
            clientMessage.OperationName = "Queue.RemoveListener";
