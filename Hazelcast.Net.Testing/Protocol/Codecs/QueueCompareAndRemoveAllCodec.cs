...
namespace Hazelcast.Protocol.Codecs
{
    ...
    ///</summary>
    internal static class QueueCompareAndRemoveAllServerCodec
    {
        public const int RequestMessageType = 199936; // 0x030D00
        public const int ResponseMessageType = 199937; // 0x030D01
        ...
        public static ClientMessage EncodeRequest(string name, ICollection<IData> dataList)
        {
            ...
            clientMessage.OperationName = "Queue.CompareAndRemoveAll";
