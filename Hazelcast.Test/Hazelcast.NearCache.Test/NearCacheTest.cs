...
{
    public class NearCacheTest : SingleMemberBaseTest
    {
        ...
        public void TestNearCacheGet()
        {
            ...
            object value;
            clientNearCache.TryGetValue(ToData("key"), out value);
        ...
        private IData ToData(object k)
        {
            return ClientInternal.SerializationService.ToData(k);
        }
    }
}