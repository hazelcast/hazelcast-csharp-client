...
namespace Hazelcast.Examples.Org.Website.Samples
{
    public class QuerySample
    {
        ...
        public static void Run(string[] args)
        {
            ...
            var sqlQuery = Predicates.Predicates.Sql("active AND age BETWEEN 18 AND 21)");
            // Creating the same Predicate as above but with a builder
            var criteriaQuery = Predicates.Predicates.And(
                Predicates.Predicates.IsEqual("active", true),
                Predicates.Predicates.IsBetween("age", 18, 21)
            );
